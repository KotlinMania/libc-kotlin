...
public actual fun msize(p: COpaquePointer?): ULong =
    throw UnsupportedOperationException("msize not available on JVM — no C library access")
...
public actual fun wcsnlen(str: WcharT?, numberOfElements: ULong): ULong =
    throw UnsupportedOperationException("wcsnlen not available on JVM — no C library access")
...
public actual fun gmtimeS(destTime: Tm?, srcTime: TimeT?): CInt =
    throw UnsupportedOperationException("gmtimeS not available on JVM — no C library access")

public actual fun getDaylight(hours: CInt?): ErrnoT =
    throw UnsupportedOperationException("getDaylight not available on JVM — no C library access")

public actual fun getDstbias(seconds: CLong?): ErrnoT =
    throw UnsupportedOperationException("getDstbias not available on JVM — no C library access")

public actual fun getTimezone(seconds: CLong?): ErrnoT =
    throw UnsupportedOperationException("getTimezone not available on JVM — no C library access")

public actual fun getTzname(pReturnValue: ULong?, timeZoneName: String?, sizeInBytes: ULong, index: CInt): ErrnoT =
    throw UnsupportedOperationException("getTzname not available on JVM — no C library access")

public actual fun localtimeS(tmDest: Tm?, sourceTime: TimeT?): ErrnoT =
    throw UnsupportedOperationException("localtimeS not available on JVM — no C library access")
...
public actual fun tzset() {
    throw UnsupportedOperationException("tzset not available on JVM — no C library access")
}
...
public actual fun wchmod(path: WcharT?, mode: CInt): CInt =
    throw UnsupportedOperationException("wchmod not available on JVM — no C library access")
...
public actual fun wrmdir(path: WcharT?): CInt =
    throw UnsupportedOperationException("wrmdir not available on JVM — no C library access")
...
public actual fun wstat(path: WcharT?, buf: Stat?): CInt =
    throw UnsupportedOperationException("wstat not available on JVM — no C library access")

public actual fun wutime(file: WcharT?, buf: Utimbuf?): CInt =
    throw UnsupportedOperationException("wutime not available on JVM — no C library access")
...
public actual fun wopen(path: WcharT?, oflag: CInt, vararg args: Any?): CInt =
    throw UnsupportedOperationException("wopen not available on JVM — no C library access")
...
public actual fun wexecl(path: WcharT?, arg0: WcharT?, vararg args: Any?): IntptrT =
    throw UnsupportedOperationException("wexecl not available on JVM — no C library access")
...
public actual fun wexecle(path: WcharT?, arg0: WcharT?, vararg args: Any?): IntptrT =
    throw UnsupportedOperationException("wexecle not available on JVM — no C library access")
...
public actual fun wexeclp(path: WcharT?, arg0: WcharT?, vararg args: Any?): IntptrT =
    throw UnsupportedOperationException("wexeclp not available on JVM — no C library access")

public actual fun execlpe(path: String?, arg0: String?, vararg args: Any?): IntptrT =
    throw UnsupportedOperationException("execlpe not available on JVM — no C library access")

public actual fun wexeclpe(path: WcharT?, arg0: WcharT?, vararg args: Any?): IntptrT =
    throw UnsupportedOperationException("wexeclpe not available on JVM — no C library access")
...
public actual fun wexecv(prog: WcharT?, argv: COpaquePointer?): IntptrT =
    throw UnsupportedOperationException("wexecv not available on JVM — no C library access")

public actual fun wexecve(prog: WcharT?, argv: COpaquePointer?, envp: COpaquePointer?): IntptrT =
    throw UnsupportedOperationException("wexecve not available on JVM — no C library access")

public actual fun wexecvp(c: WcharT?, argv: COpaquePointer?): IntptrT =
    throw UnsupportedOperationException("wexecvp not available on JVM — no C library access")

public actual fun wexecvpe(c: WcharT?, argv: COpaquePointer?, envp: COpaquePointer?): IntptrT =
    throw UnsupportedOperationException("wexecvpe not available on JVM — no C library access")
...
public actual fun commit(fd: CInt): CInt =
    throw UnsupportedOperationException("commit not available on JVM — no C library access")

public actual fun getOsfhandle(fd: CInt): IntptrT =
    throw UnsupportedOperationException("getOsfhandle not available on JVM — no C library access")

public actual fun openOsfhandle(osfhandle: IntptrT, flags: CInt): CInt =
    throw UnsupportedOperationException("openOsfhandle not available on JVM — no C library access")
...
public actual fun wsetlocale(category: CInt, locale: WcharT?): WcharT? =
    throw UnsupportedOperationException("wsetlocale not available on JVM — no C library access")

public actual fun alignedMalloc(size: ULong, alignment: ULong): COpaquePointer? =
    throw UnsupportedOperationException("alignedMalloc not available on JVM — no C library access")

public actual fun alignedFree(ptr: COpaquePointer?) {
    throw UnsupportedOperationException("alignedFree not available on JVM — no C library access")
}

public actual fun alignedRealloc(memblock: COpaquePointer?, size: ULong, alignment: ULong): COpaquePointer? =
    throw UnsupportedOperationException("alignedRealloc not available on JVM — no C library access")
...
public actual fun wputenv(envstring: WcharT?): CInt =
    throw UnsupportedOperationException("wputenv not available on JVM — no C library access")

public actual fun putenvS(envstring: String?, valueString: String?): ErrnoT =
    throw UnsupportedOperationException("putenvS not available on JVM — no C library access")

public actual fun wputenvS(envstring: WcharT?, valueString: WcharT?): ErrnoT =
    throw UnsupportedOperationException("wputenvS not available on JVM — no C library access")
...
public actual fun qsortS(base: COpaquePointer?, num: ULong, size: ULong, compar: ((COpaquePointer?, COpaquePointer?, COpaquePointer?) -> CInt)?, arg: COpaquePointer?) {
    throw UnsupportedOperationException("qsortS not available on JVM — no C library access")
}
