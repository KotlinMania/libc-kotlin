...
public actual fun dEXTRAVALID(x: DirentExtra?, d: Dirent?): Boolean =
    throw UnsupportedOperationException("dEXTRAVALID not available on JVM — no C library access")

public actual fun dEXTRANEXT(x: DirentExtra?): DirentExtra? =
    throw UnsupportedOperationException("dEXTRANEXT not available on JVM — no C library access")
...
public actual fun dircntl(dir: DIR?, cmd: CInt, vararg args: Any?): CInt =
    throw UnsupportedOperationException("dircntl not available on JVM — no C library access")
