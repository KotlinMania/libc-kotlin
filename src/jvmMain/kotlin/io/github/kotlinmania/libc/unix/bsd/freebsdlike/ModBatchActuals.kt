...
public actual fun rtprio(function: CInt, pid: PidT, rtp: Rtprio?): CInt =
    throw UnsupportedOperationException("rtprio not available on JVM — no C library access")
...
public actual fun eui64Aton(a: String?, e: Eui64?): CInt =
    throw UnsupportedOperationException("eui64Aton not available on JVM — no C library access")

public actual fun eui64Ntoa(id: Eui64?, a: String?, len: ULong): CInt =
    throw UnsupportedOperationException("eui64Ntoa not available on JVM — no C library access")

public actual fun eui64Ntohost(hostname: String?, len: ULong, id: Eui64?): CInt =
    throw UnsupportedOperationException("eui64Ntohost not available on JVM — no C library access")

public actual fun eui64Hostton(hostname: String?, id: Eui64?): CInt =
    throw UnsupportedOperationException("eui64Hostton not available on JVM — no C library access")
...
public actual fun kenv(action: CInt, name: String?, value: String?, len: CInt): CInt =
    throw UnsupportedOperationException("kenv not available on JVM — no C library access")
...
public actual fun exect(path: String?, argv: COpaquePointer?, envp: COpaquePointer?): CInt =
    throw UnsupportedOperationException("exect not available on JVM — no C library access")
...
public actual fun fparseln(stream: FILE?, len: ULong?, lineno: ULong?, delim: String?, flags: CInt): String? =
    throw UnsupportedOperationException("fparseln not available on JVM — no C library access")
...
public actual fun kvmOpen(execfile: String?, corefile: String?, swapfile: String?, flags: CInt, errstr: String?): KvmT =
    throw UnsupportedOperationException("kvmOpen not available on JVM — no C library access")

public actual fun kvmClose(kd: KvmT): CInt =
    throw UnsupportedOperationException("kvmClose not available on JVM — no C library access")

public actual fun kvmGetprocs(kd: KvmT, op: CInt, arg: CInt, cnt: CInt?): KinfoProc? =
    throw UnsupportedOperationException("kvmGetprocs not available on JVM — no C library access")

public actual fun kvmGetloadavg(kd: KvmT, loadavg: CDouble?, nelem: CInt): CInt =
    throw UnsupportedOperationException("kvmGetloadavg not available on JVM — no C library access")

public actual fun kvmOpenfiles(execfile: String?, corefile: String?, swapfile: String?, flags: CInt, errbuf: String?): KvmT =
    throw UnsupportedOperationException("kvmOpenfiles not available on JVM — no C library access")

public actual fun kvmRead(kd: KvmT, addr: CULong, buf: COpaquePointer?, nbytes: ULong): SsizeT =
    throw UnsupportedOperationException("kvmRead not available on JVM — no C library access")

public actual fun kvmWrite(kd: KvmT, addr: CULong, buf: COpaquePointer?, nbytes: ULong): SsizeT =
    throw UnsupportedOperationException("kvmWrite not available on JVM — no C library access")
