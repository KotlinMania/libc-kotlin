...
public actual fun sIGRTMAX(): CInt =
    throw UnsupportedOperationException("sIGRTMAX not available on JVM — no C library access")

public actual fun sIGRTMIN(): CInt =
    throw UnsupportedOperationException("sIGRTMIN not available on JVM — no C library access")
...
public actual fun stackGetbounds(sp: StackT?): CInt =
    throw UnsupportedOperationException("stackGetbounds not available on JVM — no C library access")
...
public actual fun posixSpawnFileActionsAddclosefromNp(fileActions: PosixSpawnFileActionsT, lowfiledes: CInt): CInt =
    throw UnsupportedOperationException("posixSpawnFileActionsAddclosefromNp not available on JVM — no C library access")

public actual fun posixSpawnFileActionsAddchdir(fileActions: PosixSpawnFileActionsT, path: String?): CInt =
    throw UnsupportedOperationException("posixSpawnFileActionsAddchdir not available on JVM — no C library access")

public actual fun posixSpawnFileActionsAddchdirNp(fileActions: PosixSpawnFileActionsT, path: String?): CInt =
    throw UnsupportedOperationException("posixSpawnFileActionsAddchdirNp not available on JVM — no C library access")

public actual fun posixSpawnFileActionsAddfchdir(fileActions: PosixSpawnFileActionsT, fd: CInt): CInt =
    throw UnsupportedOperationException("posixSpawnFileActionsAddfchdir not available on JVM — no C library access")
...
public actual fun posixSpawnattrSetsigignoreNp(attr: PosixSpawnattrT, sigignore: SigsetT?): CInt =
    throw UnsupportedOperationException("posixSpawnattrSetsigignoreNp not available on JVM — no C library access")

public actual fun posixSpawnattrGetsigignoreNp(attr: PosixSpawnattrT, sigignore: SigsetT?): CInt =
    throw UnsupportedOperationException("posixSpawnattrGetsigignoreNp not available on JVM — no C library access")
...
public actual fun futimesat(fd: CInt, path: String?, times: Timeval?): CInt =
    throw UnsupportedOperationException("futimesat not available on JVM — no C library access")
...
public actual fun portCreate(): CInt =
    throw UnsupportedOperationException("portCreate not available on JVM — no C library access")

public actual fun portAssociate(port: CInt, source: CInt, `object`: UintptrT, events: CInt, user: COpaquePointer?): CInt =
    throw UnsupportedOperationException("portAssociate not available on JVM — no C library access")

public actual fun portDissociate(port: CInt, source: CInt, `object`: UintptrT): CInt =
    throw UnsupportedOperationException("portDissociate not available on JVM — no C library access")

public actual fun portGet(port: CInt, pe: PortEvent?, timeout: Timespec?): CInt =
    throw UnsupportedOperationException("portGet not available on JVM — no C library access")

public actual fun portGetn(port: CInt, peList: PortEvent?, max: CUInt, nget: CUInt?, timeout: Timespec?): CInt =
    throw UnsupportedOperationException("portGetn not available on JVM — no C library access")

public actual fun portSend(port: CInt, events: CInt, user: COpaquePointer?): CInt =
    throw UnsupportedOperationException("portSend not available on JVM — no C library access")

public actual fun portSendn(portList: CInt?, errorList: CInt?, nent: CUInt, events: CInt, user: COpaquePointer?): CInt =
    throw UnsupportedOperationException("portSendn not available on JVM — no C library access")
...
public actual fun makeutx(ux: Utmpx?): Utmpx? =
    throw UnsupportedOperationException("makeutx not available on JVM — no C library access")

public actual fun modutx(ux: Utmpx?): Utmpx? =
    throw UnsupportedOperationException("modutx not available on JVM — no C library access")
...
public actual fun ucredGet(pid: PidT): UcredT =
    throw UnsupportedOperationException("ucredGet not available on JVM — no C library access")

public actual fun getpeerucred(fd: CInt, ucred: COpaquePointer?): CInt =
    throw UnsupportedOperationException("getpeerucred not available on JVM — no C library access")

public actual fun ucredFree(ucred: UcredT) {
    throw UnsupportedOperationException("ucredFree not available on JVM — no C library access")
}

public actual fun ucredGetgroups(ucred: UcredT, groups: COpaquePointer?): CInt =
    throw UnsupportedOperationException("ucredGetgroups not available on JVM — no C library access")

public actual fun ucredGetpid(ucred: UcredT): PidT =
    throw UnsupportedOperationException("ucredGetpid not available on JVM — no C library access")

public actual fun ucredSize(): ULong =
    throw UnsupportedOperationException("ucredSize not available on JVM — no C library access")

public actual fun psetCreate(newpset: PsetidT?): CInt =
    throw UnsupportedOperationException("psetCreate not available on JVM — no C library access")

public actual fun psetDestroy(pset: PsetidT): CInt =
    throw UnsupportedOperationException("psetDestroy not available on JVM — no C library access")

public actual fun psetAssign(pset: PsetidT, cpu: ProcessoridT, opset: PsetidT?): CInt =
    throw UnsupportedOperationException("psetAssign not available on JVM — no C library access")

public actual fun psetInfo(pset: PsetidT, tpe: CInt?, numcpus: CUInt?, cpulist: ProcessoridT?): CInt =
    throw UnsupportedOperationException("psetInfo not available on JVM — no C library access")

public actual fun psetBind(pset: PsetidT, idtype: IdtypeT, id: IdT, opset: PsetidT?): CInt =
    throw UnsupportedOperationException("psetBind not available on JVM — no C library access")

public actual fun psetList(pset: PsetidT?, numpsets: CUInt?): CInt =
    throw UnsupportedOperationException("psetList not available on JVM — no C library access")

public actual fun psetSetattr(pset: PsetidT, attr: CUInt): CInt =
    throw UnsupportedOperationException("psetSetattr not available on JVM — no C library access")

public actual fun psetGetattr(pset: PsetidT, attr: CUInt?): CInt =
    throw UnsupportedOperationException("psetGetattr not available on JVM — no C library access")

public actual fun processorBind(idtype: IdtypeT, id: IdT, newBinding: ProcessoridT, oldBinding: ProcessoridT?): CInt =
    throw UnsupportedOperationException("processorBind not available on JVM — no C library access")

public actual fun pOnline(processorid: ProcessoridT, flag: CInt): CInt =
    throw UnsupportedOperationException("pOnline not available on JVM — no C library access")

public actual fun processorInfo(processorid: ProcessoridT, infop: ProcessorInfoT?): CInt =
    throw UnsupportedOperationException("processorInfo not available on JVM — no C library access")

public actual fun getexecname(): String? =
    throw UnsupportedOperationException("getexecname not available on JVM — no C library access")
...
public actual fun setpflags(flags: CUInt, value: CUInt): CInt =
    throw UnsupportedOperationException("setpflags not available on JVM — no C library access")
...
public actual fun mmapobj(fd: CInt, flags: CUInt, storage: MmapobjResultT?, elements: CUInt?, arg: COpaquePointer?): CInt =
    throw UnsupportedOperationException("mmapobj not available on JVM — no C library access")

public actual fun meminfo(inaddr: ULong?, addrCount: CInt, infoReq: CUInt?, infoCount: CInt, outdata: ULong?, validity: CUInt?): CInt =
    throw UnsupportedOperationException("meminfo not available on JVM — no C library access")
...
public actual fun aioWaitn(aiocbList: COpaquePointer?, nent: CUInt, nwait: CUInt?, timeout: Timespec?): CInt =
    throw UnsupportedOperationException("aioWaitn not available on JVM — no C library access")
...
public actual fun secureGetenv(name: String?): String? =
    throw UnsupportedOperationException("secureGetenv not available on JVM — no C library access")
...
public actual fun sendfilev(fildes: CInt, vec: SendfilevecT?, sfvcnt: CInt, xferred: ULong?): SsizeT =
    throw UnsupportedOperationException("sendfilev not available on JVM — no C library access")

public actual fun lgrpFini(cookie: LgrpCookieT): CInt =
    throw UnsupportedOperationException("lgrpFini not available on JVM — no C library access")

public actual fun lgrpAffinitySet(idtype: IdtypeT, id: IdT, lgrp: LgrpIdT, aff: LgrpAffinityT): CInt =
    throw UnsupportedOperationException("lgrpAffinitySet not available on JVM — no C library access")

public actual fun lgrpCpus(cookie: LgrpCookieT, lgrp: LgrpIdT, cpuids: ProcessoridT?, count: CUInt, content: LgrpContentT): CInt =
    throw UnsupportedOperationException("lgrpCpus not available on JVM — no C library access")

public actual fun lgrpNlgrps(cookie: LgrpCookieT): CInt =
    throw UnsupportedOperationException("lgrpNlgrps not available on JVM — no C library access")

public actual fun lgrpVersion(version: CInt): CInt =
    throw UnsupportedOperationException("lgrpVersion not available on JVM — no C library access")

public actual fun lgrpResources(cookie: LgrpCookieT, lgrp: LgrpIdT, lgrps: LgrpIdT?, count: CUInt, tpe: LgrpRsrcT): CInt =
    throw UnsupportedOperationException("lgrpResources not available on JVM — no C library access")
