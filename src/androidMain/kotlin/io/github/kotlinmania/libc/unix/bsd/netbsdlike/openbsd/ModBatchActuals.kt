...
public actual fun pledge(promises: String?, execpromises: String?): CInt =
    throw UnsupportedOperationException("pledge not available on Android host — use androidNative target for FFI")

public actual fun unveil(path: String?, permissions: String?): CInt =
    throw UnsupportedOperationException("unveil not available on Android host — use androidNative target for FFI")
...
public actual fun getthrid(): PidT =
    throw UnsupportedOperationException("getthrid not available on Android host — use androidNative target for FFI")
...
public actual fun futex(uaddr: UInt?, op: CInt, `val`: CInt, timeout: Timespec?, uaddr2: UInt?): CInt =
    throw UnsupportedOperationException("futex not available on Android host — use androidNative target for FFI")

public actual fun mimmutable(addr: COpaquePointer?, len: ULong): CInt =
    throw UnsupportedOperationException("mimmutable not available on Android host — use androidNative target for FFI")
