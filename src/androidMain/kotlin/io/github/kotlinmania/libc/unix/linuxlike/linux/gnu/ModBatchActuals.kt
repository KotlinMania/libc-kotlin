...
public actual fun adjtimex(buf: Timex?): CInt =
    throw UnsupportedOperationException("adjtimex not available on Android host — use androidNative target for FFI")
...
public actual fun clockAdjtime(clkId: ClockidT, buf: Timex?): CInt =
    throw UnsupportedOperationException("clockAdjtime not available on Android host — use androidNative target for FFI")

public actual fun fanotifyMark(fd: CInt, flags: CUInt, mask: ULong, dirfd: CInt, path: String?): CInt =
    throw UnsupportedOperationException("fanotifyMark not available on Android host — use androidNative target for FFI")

public actual fun preadv2(fd: CInt, iov: Iovec?, iovcnt: CInt, offset: OffT, flags: CInt): SsizeT =
    throw UnsupportedOperationException("preadv2 not available on Android host — use androidNative target for FFI")

public actual fun pwritev2(fd: CInt, iov: Iovec?, iovcnt: CInt, offset: OffT, flags: CInt): SsizeT =
    throw UnsupportedOperationException("pwritev2 not available on Android host — use androidNative target for FFI")

public actual fun preadv64v2(fd: CInt, iov: Iovec?, iovcnt: CInt, offset: Off64T, flags: CInt): SsizeT =
    throw UnsupportedOperationException("preadv64v2 not available on Android host — use androidNative target for FFI")

public actual fun pwritev64v2(fd: CInt, iov: Iovec?, iovcnt: CInt, offset: Off64T, flags: CInt): SsizeT =
    throw UnsupportedOperationException("pwritev64v2 not available on Android host — use androidNative target for FFI")
...
public actual fun pthreadTryjoinNp(thread: PthreadT, retval: COpaquePointer?): CInt =
    throw UnsupportedOperationException("pthreadTryjoinNp not available on Android host — use androidNative target for FFI")
...
public actual fun mallocStats() {
    throw UnsupportedOperationException("mallocStats not available on Android host — use androidNative target for FFI")
}
...
public actual fun epollPwait2(epfd: CInt, events: EpollEvent?, maxevents: CInt, timeout: Timespec?, sigmask: SigsetT?): CInt =
    throw UnsupportedOperationException("epollPwait2 not available on Android host — use androidNative target for FFI")

public actual fun mempcpy(dest: COpaquePointer?, src: COpaquePointer?, n: ULong): COpaquePointer? =
    throw UnsupportedOperationException("mempcpy not available on Android host — use androidNative target for FFI")
