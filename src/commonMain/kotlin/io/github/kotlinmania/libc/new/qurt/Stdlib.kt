...
public expect fun strtol(nptr: String?, endptr: String?, base: CInt): CLong

public expect fun strtoul(nptr: String?, endptr: String?, base: CInt): CULong

public expect fun strtoll(nptr: String?, endptr: String?, base: CInt): CLongLong

public expect fun strtoull(nptr: String?, endptr: String?, base: CInt): CULongLong

public expect fun strtod(nptr: String?, endptr: String?): CDouble

public expect fun strtof(nptr: String?, endptr: String?): CFloat

public expect fun rand(): CInt

public expect fun srand(seed: CUInt)

public expect fun qsort(
    base: COpaquePointer?,
    nmemb: ULong,
    size: ULong,
    compar: (COpaquePointer?, COpaquePointer?) -> CInt,
)

public expect fun bsearch(
    key: COpaquePointer?,
    base: COpaquePointer?,
    nmemb: ULong,
    size: ULong,
