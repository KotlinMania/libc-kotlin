...
/**
 * Re-export wiring for `new/musl/pthread.rs` (no definitions of its own).
 *
 * Header: `pthread.h`
 *
 ...
 * - crate::new::common::linux_like::pthread::{ pthread_getaffinity_np, pthread_getattr_np, pthread_getname_np, pthread_setaffinity_np, pthread_setname_np, }
 ...
 * - crate::new::common::posix::pthread::{ pthread_cancel, pthread_mutex_consistent, pthread_mutexattr_getrobust, pthread_mutexattr_setrobust, }
 */
