// port-lint: source libc/src/new/linux_uapi/linux/can/j1939.rs
...
public val J1939_MAX_UNICAST_ADDR: CUChar = (0xfd).toUByte()
public val J1939_IDLE_ADDR: CUChar = (0xfe).toUByte()
public val J1939_NO_ADDR: CUChar = (0xff).toUByte()
