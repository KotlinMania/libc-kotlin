...
public val B_READ_AREA: UInt = 1 shl 0
public val B_WRITE_AREA: UInt = 1 shl 1
public val B_EXECUTE_AREA: UInt = 1 shl 2
public val B_STACK_AREA: UInt = 1 shl 3
public val B_CLONEABLE_AREA: UInt = 1 shl 8
...
public const val B_ATTR_NAME_LENGTH: ULong = B_FILE_NAME_LENGTH - 1
public const val B_MIME_TYPE_LENGTH: ULong = B_ATTR_NAME_LENGTH - 15
