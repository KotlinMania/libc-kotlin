// port-lint: source unix/linux_like/android/b64/aarch64/mod.rs
package io.github.kotlinmania.libc.unix.linuxlike.android.b64.aarch64
...
public data class McontextT(
    val faultAddress: CULongLong,
    val regs: ULongArray,
    val sp: CULongLong,
    val pc: CULongLong,
    val pstate: CULongLong,
)

public data class UserFpsimdStruct(
    val vregs: List<Uint128T>,
    val fpsr: UInt,
    val fpcr: UInt,
)
...
public const val MINSIGSTKSZ: ULong = 5120uL
public val HWCAP_FP: CULong = 1.toULong() shl 0
public val HWCAP_ASIMD: CULong = 1.toULong() shl 1
public val HWCAP_EVTSTRM: CULong = 1.toULong() shl 2
public val HWCAP_AES: CULong = 1.toULong() shl 3
public val HWCAP_PMULL: CULong = 1.toULong() shl 4
public val HWCAP_SHA1: CULong = 1.toULong() shl 5
public val HWCAP_SHA2: CULong = 1.toULong() shl 6
public val HWCAP_CRC32: CULong = 1.toULong() shl 7
public val HWCAP_ATOMICS: CULong = 1.toULong() shl 8
public val HWCAP_FPHP: CULong = 1.toULong() shl 9
public val HWCAP_ASIMDHP: CULong = 1.toULong() shl 10
public val HWCAP_CPUID: CULong = 1.toULong() shl 11
public val HWCAP_ASIMDRDM: CULong = 1.toULong() shl 12
public val HWCAP_JSCVT: CULong = 1.toULong() shl 13
public val HWCAP_FCMA: CULong = 1.toULong() shl 14
public val HWCAP_LRCPC: CULong = 1.toULong() shl 15
public val HWCAP_DCPOP: CULong = 1.toULong() shl 16
public val HWCAP_SHA3: CULong = 1.toULong() shl 17
public val HWCAP_SM3: CULong = 1.toULong() shl 18
public val HWCAP_SM4: CULong = 1.toULong() shl 19
public val HWCAP_ASIMDDP: CULong = 1.toULong() shl 20
public val HWCAP_SHA512: CULong = 1.toULong() shl 21
public val HWCAP_SVE: CULong = 1.toULong() shl 22
public val HWCAP_ASIMDFHM: CULong = 1.toULong() shl 23
public val HWCAP_DIT: CULong = 1.toULong() shl 24
public val HWCAP_USCAT: CULong = 1.toULong() shl 25
public val HWCAP_ILRCPC: CULong = 1.toULong() shl 26
public val HWCAP_FLAGM: CULong = 1.toULong() shl 27
public val HWCAP_SSBS: CULong = 1.toULong() shl 28
public val HWCAP_SB: CULong = 1.toULong() shl 29
public val HWCAP_PACA: CULong = 1.toULong() shl 30
public val HWCAP_PACG: CULong = 1.toULong() shl 31
public val HWCAP2_DCPODP: CULong = 1.toULong() shl 0
public val HWCAP2_SVE2: CULong = 1.toULong() shl 1
public val HWCAP2_SVEAES: CULong = 1.toULong() shl 2
public val HWCAP2_SVEPMULL: CULong = 1.toULong() shl 3
public val HWCAP2_SVEBITPERM: CULong = 1.toULong() shl 4
public val HWCAP2_SVESHA3: CULong = 1.toULong() shl 5
public val HWCAP2_SVESM4: CULong = 1.toULong() shl 6
public val HWCAP2_FLAGM2: CULong = 1.toULong() shl 7
public val HWCAP2_FRINT: CULong = 1.toULong() shl 8
public val HWCAP2_SVEI8MM: CULong = 1.toULong() shl 9
public val HWCAP2_SVEF32MM: CULong = 1.toULong() shl 10
public val HWCAP2_SVEF64MM: CULong = 1.toULong() shl 11
public val HWCAP2_SVEBF16: CULong = 1.toULong() shl 12
public val HWCAP2_I8MM: CULong = 1.toULong() shl 13
public val HWCAP2_BF16: CULong = 1.toULong() shl 14
public val HWCAP2_DGH: CULong = 1.toULong() shl 15
public val HWCAP2_RNG: CULong = 1.toULong() shl 16
public val HWCAP2_BTI: CULong = 1.toULong() shl 17
public val HWCAP2_MTE: CULong = 1.toULong() shl 18
public val HWCAP2_ECV: CULong = 1.toULong() shl 19
public val HWCAP2_AFP: CULong = 1.toULong() shl 20
public val HWCAP2_RPRES: CULong = 1.toULong() shl 21
public val HWCAP2_MTE3: CULong = 1.toULong() shl 22
public val HWCAP2_SME: CULong = 1.toULong() shl 23
public val HWCAP2_SME_I16I64: CULong = 1.toULong() shl 24
public val HWCAP2_SME_F64F64: CULong = 1.toULong() shl 25
public val HWCAP2_SME_I8I32: CULong = 1.toULong() shl 26
public val HWCAP2_SME_F16F32: CULong = 1.toULong() shl 27
public val HWCAP2_SME_B16F32: CULong = 1.toULong() shl 28
public val HWCAP2_SME_F32F32: CULong = 1.toULong() shl 29
public val HWCAP2_SME_FA64: CULong = 1.toULong() shl 30
public val HWCAP2_WFXT: CULong = 1.toULong() shl 31
public val HWCAP2_EBF16: CULong = 1.toULong() shl 32
public val HWCAP2_SVE_EBF16: CULong = 1.toULong() shl 33
