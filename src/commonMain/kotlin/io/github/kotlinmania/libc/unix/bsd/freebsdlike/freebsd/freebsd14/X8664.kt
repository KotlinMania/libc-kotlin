// port-lint: source unix/bsd/freebsdlike/freebsd/freebsd14/x86_64.rs
...
public const val PROC_KPTI_STATUS: CInt = PROC_PROCCTL_MD_MIN + 1
public const val PROC_KPTI_STATUS_ACTIVE: CInt = 0x80000000
public const val PROC_LA_CTL: CInt = PROC_PROCCTL_MD_MIN + 2
public const val PROC_LA_STATUS: CInt = PROC_PROCCTL_MD_MIN + 3
