...
public const val CLOCK_REALTIME_COARSE: ClockidT = 0uL
public const val CLOCK_REALTIME: ClockidT = 1uL
public const val CLOCK_PROCESS_CPUTIME_ID: ClockidT = 2uL
public const val CLOCK_THREAD_CPUTIME_ID: ClockidT = 3uL
public const val CLOCK_MONOTONIC: ClockidT = 4uL
public const val CLOCK_MONOTONIC_RAW: ClockidT = 5uL
public const val CLOCK_MONOTONIC_COARSE: ClockidT = 6uL
public const val CLOCK_BOOTTIME: ClockidT = 7uL
public const val CLOCK_REALTIME_ALARM: ClockidT = 8uL
public const val CLOCK_BOOTTIME_ALARM: ClockidT = 9uL
...
public const val FIOASYNC: CInt = 0x8008667d.toInt()
...
public val IPTOS_MINCOST: UByte = IPTOS_LOWCOST
...
public const val IGNBRK: TcflagT = 0x00001u
public const val BRKINT: TcflagT = 0x00002u
public const val IGNPAR: TcflagT = 0x00004u
public const val IMAXBEL: TcflagT = 0x00008u
public const val INPCK: TcflagT = 0x00010u
public const val ISTRIP: TcflagT = 0x00020u
public const val INLCR: TcflagT = 0x00040u
public const val IGNCR: TcflagT = 0x00080u
public const val ICRNL: TcflagT = 0x00100u
public const val IXON: TcflagT = 0x00400u
public const val IXOFF: TcflagT = 0x01000u
public const val IUCLC: TcflagT = 0x04000u
public const val IXANY: TcflagT = 0x08000u
public const val PARMRK: TcflagT = 0x10000u
public const val IUTF8: TcflagT = 0x20000u
public const val OPOST: TcflagT = 0x00001u
public const val OLCUC: TcflagT = 0x00002u
public const val OCRNL: TcflagT = 0x00004u
public const val ONLCR: TcflagT = 0x00008u
public const val ONOCR: TcflagT = 0x00010u
public const val ONLRET: TcflagT = 0x00020u
public const val OFILL: TcflagT = 0x00040u
public const val CRDLY: TcflagT = 0x00180u
public const val CR0: TcflagT = 0x00000u
public const val CR1: TcflagT = 0x00080u
public const val CR2: TcflagT = 0x00100u
public const val CR3: TcflagT = 0x00180u
public const val NLDLY: TcflagT = 0x00200u
public const val NL0: TcflagT = 0x00000u
public const val NL1: TcflagT = 0x00200u
public const val BSDLY: TcflagT = 0x00400u
public const val BS0: TcflagT = 0x00000u
public const val BS1: TcflagT = 0x00400u
public const val TABDLY: TcflagT = 0x01800u
public const val TAB0: TcflagT = 0x00000u
public const val TAB1: TcflagT = 0x00800u
public const val TAB2: TcflagT = 0x01000u
public const val TAB3: TcflagT = 0x01800u
public const val XTABS: TcflagT = 0x01800u
public const val VTDLY: TcflagT = 0x02000u
public const val VT0: TcflagT = 0x00000u
public const val VT1: TcflagT = 0x02000u
public const val FFDLY: TcflagT = 0x04000u
public const val FF0: TcflagT = 0x00000u
public const val FF1: TcflagT = 0x04000u
public const val OFDEL: TcflagT = 0x08000u
public const val CBAUD: TcflagT = 0x0100fu
public const val B0: SpeedT = 0x00000u
public const val B50: SpeedT = 0x00001u
public const val B75: SpeedT = 0x00002u
public const val B110: SpeedT = 0x00003u
public const val B134: SpeedT = 0x00004u
public const val B150: SpeedT = 0x00005u
public const val B200: SpeedT = 0x00006u
public const val B300: SpeedT = 0x00007u
public const val B600: SpeedT = 0x00008u
public const val B1200: SpeedT = 0x00009u
public const val B1800: SpeedT = 0x0000au
public const val B2400: SpeedT = 0x0000bu
public const val B4800: SpeedT = 0x0000cu
public const val B9600: SpeedT = 0x0000du
public const val B19200: SpeedT = 0x0000eu
public const val B38400: SpeedT = 0x0000fu
public const val CSIZE: TcflagT = 0x00030u
public const val CS5: TcflagT = 0x00000u
public const val CS6: TcflagT = 0x00010u
public const val CS7: TcflagT = 0x00020u
public const val CS8: TcflagT = 0x00030u
public const val CSTOPB: TcflagT = 0x00040u
public const val CREAD: TcflagT = 0x00080u
public const val PARENB: TcflagT = 0x00100u
public const val PARODD: TcflagT = 0x00200u
public const val HUPCL: TcflagT = 0x00400u
public const val CLOCAL: TcflagT = 0x00800u
public const val CBAUDEX: TcflagT = 0x0100fu
public const val B57600: SpeedT = 0x01001u
public const val B115200: SpeedT = 0x01002u
public const val B230400: SpeedT = 0x01004u
public const val B460800: SpeedT = 0x01006u
public const val B500000: SpeedT = 0x01007u
public const val B576000: SpeedT = 0x01008u
public const val B921600: SpeedT = 0x01009u
public const val B1000000: SpeedT = 0x0100au
public const val B1152000: SpeedT = 0x0100bu
public const val B1500000: SpeedT = 0x0100cu
public const val B2000000: SpeedT = 0x0100du
public const val B2500000: SpeedT = 0x0100eu
public const val B3000000: SpeedT = 0x0100fu
public const val CRTSCTS: TcflagT = 0x08000u
public const val CMSPAR: TcflagT = 0x40000000u
public const val ISIG: TcflagT = 0x0001u
public const val ICANON: TcflagT = 0x0002u
public const val ECHO: TcflagT = 0x0004u
public const val ECHOE: TcflagT = 0x0008u
public const val ECHOK: TcflagT = 0x0010u
public const val ECHONL: TcflagT = 0x0020u
public const val NOFLSH: TcflagT = 0x0040u
public const val TOSTOP: TcflagT = 0x0080u
public const val IEXTEN: TcflagT = 0x0100u
public const val FLUSHO: TcflagT = 0x0200u
public const val ECHOKE: TcflagT = 0x0400u
public const val ECHOCTL: TcflagT = 0x0800u
...
public fun cMSGLEN(length: CUInt): CUInt = 0u
...
public fun getnameinfo(sa: Sockaddr?, salen: SocklenT, host: String?, hostlen: SocklenT, serv: String?, sevlen: SocklenT, flags: CInt): CInt = -1
...
public fun mount(src: String?, target: String?, flags: CUInt): CInt = -1

public fun umount(target: String?): CInt = -1

public fun cygwinUmount(target: String?, flags: CUInt): CInt = -1
...
public fun posixSpawnFileActionsAddchdir(actions: PosixSpawnFileActionsT, path: String?): CInt = -1

public fun posixSpawnFileActionsAddfchdir(actions: PosixSpawnFileActionsT, fd: CInt): CInt = -1
...
public fun getutxid(id: Utmpx?): Utmpx? = null

public fun getutxline(line: Utmpx?): Utmpx? = null

public fun pututxline(utmpx: Utmpx?): Utmpx? = null

public fun setutxent() { }

public fun utmpxname(file: String?): CInt = -1

public fun updwtmpx(file: String?, utmpx: Utmpx?) { }
