// port-lint: source libc/src/unix/linux_like/android/mod.rs
...
public val EFD_NONBLOCK: CInt = O_NONBLOCK
public const val TFD_CLOEXEC: CInt = O_CLOEXEC
public val TFD_NONBLOCK: CInt = O_NONBLOCK
...
public const val TCGETS2: CInt = 0x802c542a.toInt()
...
public const val KEXEC_ARCH_MASK: CInt = 0xffff0000.toInt()
...
public const val LINUX_REBOOT_MAGIC1: CInt = 0xfee1dead.toInt()
...
public const val LINUX_REBOOT_CMD_HALT: CInt = 0xCDEF0123.toInt()
public const val LINUX_REBOOT_CMD_CAD_ON: CInt = 0x89ABCDEF.toInt()
public const val LINUX_REBOOT_CMD_CAD_OFF: CInt = 0x00000000
public const val LINUX_REBOOT_CMD_POWER_OFF: CInt = 0x4321FEDC
public const val LINUX_REBOOT_CMD_RESTART2: CInt = 0xA1B2C3D4.toInt()
public const val LINUX_REBOOT_CMD_SW_SUSPEND: CInt = 0xD000FCE2.toInt()
...
public const val IUCLC: TcflagT = 0x00000200u
...
public val SECCOMP_FILTER_FLAG_TSYNC: CULong = 1uL shl 0
public val SECCOMP_FILTER_FLAG_LOG: CULong = 1uL shl 1
public val SECCOMP_FILTER_FLAG_SPEC_ALLOW: CULong = 1uL shl 2
public val SECCOMP_FILTER_FLAG_NEW_LISTENER: CULong = 1uL shl 3
public val SECCOMP_FILTER_FLAG_TSYNC_ESRCH: CULong = 1uL shl 4
public val SECCOMP_FILTER_FLAG_WAIT_KILLABLE_RECV: CULong = 1uL shl 5
...
public const val NF_VERDICT_QMASK: CInt = 0xffff0000.toInt()
...
public const val SW_MAX: U16 = 0x0fu
...
public val NDA_PROTOCOL: CUShort = (12).toUShort()
public val NDA_NH_ID: CUShort = (13).toUShort()
public val NDA_FDB_EXT_ATTRS: CUShort = (14).toUShort()
public val NDA_FLAGS_EXT: CUShort = (15).toUShort()
public val NDA_NDM_STATE_MASK: CUShort = (16).toUShort()
public val NDA_NDM_FLAGS_MASK: CUShort = (17).toUShort()
...
public val NTF_STICKY: UByte = (0x40).toUByte()
public val NTF_ROUTER: UByte = (0x80).toUByte()
public val NTF_EXT_MANAGED: UByte = (0x01).toUByte()
public val NTF_EXT_LOCKED: UByte = (0x02).toUByte()
...
public val NDTPA_UNSPEC: CUShort = (0).toUShort()
public val NDTPA_IFINDEX: CUShort = (1).toUShort()
public val NDTPA_REFCNT: CUShort = (2).toUShort()
public val NDTPA_REACHABLE_TIME: CUShort = (3).toUShort()
public val NDTPA_BASE_REACHABLE_TIME: CUShort = (4).toUShort()
public val NDTPA_RETRANS_TIME: CUShort = (5).toUShort()
public val NDTPA_GC_STALETIME: CUShort = (6).toUShort()
public val NDTPA_DELAY_PROBE_TIME: CUShort = (7).toUShort()
public val NDTPA_QUEUE_LEN: CUShort = (8).toUShort()
public val NDTPA_APP_PROBES: CUShort = (9).toUShort()
public val NDTPA_UCAST_PROBES: CUShort = (10).toUShort()
public val NDTPA_MCAST_PROBES: CUShort = (11).toUShort()
public val NDTPA_ANYCAST_DELAY: CUShort = (12).toUShort()
public val NDTPA_PROXY_DELAY: CUShort = (13).toUShort()
public val NDTPA_PROXY_QLEN: CUShort = (14).toUShort()
public val NDTPA_LOCKTIME: CUShort = (15).toUShort()
public val NDTPA_QUEUE_LENBYTES: CUShort = (16).toUShort()
public val NDTPA_MCAST_REPROBES: CUShort = (17).toUShort()
public val NDTPA_PAD: CUShort = (18).toUShort()
public val NDTPA_INTERVAL_PROBE_TIME_MS: CUShort = (19).toUShort()
public val NDTA_UNSPEC: CUShort = (0).toUShort()
public val NDTA_NAME: CUShort = (1).toUShort()
public val NDTA_THRESH1: CUShort = (2).toUShort()
public val NDTA_THRESH2: CUShort = (3).toUShort()
public val NDTA_THRESH3: CUShort = (4).toUShort()
public val NDTA_CONFIG: CUShort = (5).toUShort()
public val NDTA_PARMS: CUShort = (6).toUShort()
public val NDTA_STATS: CUShort = (7).toUShort()
public val NDTA_GC_INTERVAL: CUShort = (8).toUShort()
public val NDTA_PAD: CUShort = (9).toUShort()
public val FDB_NOTIFY_BIT: UShort = (0x01).toUShort()
public val FDB_NOTIFY_INACTIVE_BIT: UShort = (0x02).toUShort()
public val NFEA_UNSPEC: CUShort = (0).toUShort()
public val NFEA_ACTIVITY_NOTIFY: CUShort = (1).toUShort()
public val NFEA_DONT_REFRESH: CUShort = (2).toUShort()
...
public val SOF_TIMESTAMPING_TX_HARDWARE: CUInt = 1u shl 0
public val SOF_TIMESTAMPING_TX_SOFTWARE: CUInt = 1u shl 1
public val SOF_TIMESTAMPING_RX_HARDWARE: CUInt = 1u shl 2
public val SOF_TIMESTAMPING_RX_SOFTWARE: CUInt = 1u shl 3
public val SOF_TIMESTAMPING_SOFTWARE: CUInt = 1u shl 4
public val SOF_TIMESTAMPING_SYS_HARDWARE: CUInt = 1u shl 5
public val SOF_TIMESTAMPING_RAW_HARDWARE: CUInt = 1u shl 6
public val SOF_TIMESTAMPING_OPT_ID: CUInt = 1u shl 7
public val SOF_TIMESTAMPING_TX_SCHED: CUInt = 1u shl 8
public val SOF_TIMESTAMPING_TX_ACK: CUInt = 1u shl 9
public val SOF_TIMESTAMPING_OPT_CMSG: CUInt = 1u shl 10
public val SOF_TIMESTAMPING_OPT_TSONLY: CUInt = 1u shl 11
public val SOF_TIMESTAMPING_OPT_STATS: CUInt = 1u shl 12
public val SOF_TIMESTAMPING_OPT_PKTINFO: CUInt = 1u shl 13
public val SOF_TIMESTAMPING_OPT_TX_SWHW: CUInt = 1u shl 14
public val SOF_TIMESTAMPING_BIND_PHC: CUInt = 1u shl 15
public val SOF_TIMESTAMPING_OPT_ID_TCP: CUInt = 1u shl 16
public val SOF_TIMESTAMPING_OPT_RX_FILTER: CUInt = 1u shl 17
...
public const val IN_EXCL_UNLINK: UInt = 0x04000000u
...
public val PR_SPEC_PRCTL: CULong = 1uL shl 0
public val PR_SPEC_ENABLE: CULong = 1uL shl 1
public val PR_SPEC_DISABLE: CULong = 1uL shl 2
public val PR_SPEC_FORCE_DISABLE: CULong = 1uL shl 3
public val PR_SPEC_DISABLE_NOEXEC: CULong = 1uL shl 4
public const val PR_PAC_RESET_KEYS: CInt = 54
public val PR_PAC_APIAKEY: CULong = 1uL shl 0
public val PR_PAC_APIBKEY: CULong = 1uL shl 1
public val PR_PAC_APDAKEY: CULong = 1uL shl 2
public val PR_PAC_APDBKEY: CULong = 1uL shl 3
public val PR_PAC_APGAKEY: CULong = 1uL shl 4
public const val PR_SET_TAGGED_ADDR_CTRL: CInt = 55
public const val PR_GET_TAGGED_ADDR_CTRL: CInt = 56
public val PR_TAGGED_ADDR_ENABLE: CULong = 1uL shl 0
public const val PR_MTE_TCF_NONE: CULong = 0uL
public val PR_MTE_TCF_SYNC: CULong = 1uL shl 1
public val PR_MTE_TCF_ASYNC: CULong = 1uL shl 2
public val PR_MTE_TCF_MASK: CULong = PR_MTE_TCF_SYNC or PR_MTE_TCF_ASYNC
public const val PR_MTE_TAG_SHIFT: CULong = 3uL
public val PR_MTE_TAG_MASK: CULong = 0xffffuL shl PR_MTE_TAG_SHIFT.toInt()
...
public val PR_MDWE_REFUSE_EXEC_GAIN: CULong = 1uL shl 0
public val PR_MDWE_NO_INHERIT: CULong = 1uL shl 1
...
public val IFLA_DEVLINK_PORT: CUShort = (62).toUShort()
public val IFLA_GSO_IPV4_MAX_SIZE: CUShort = (63).toUShort()
public val IFLA_GRO_IPV4_MAX_SIZE: CUShort = (64).toUShort()
...
public const val PF_SUSPEND_TASK: CInt = 0x80000000.toInt()
...
public fun sOEEOFFENDER(ee: SockExtendedErr?): Sockaddr? = null
...
public fun getrlimit64(resource: CInt, rlim: Rlimit64?): CInt = -1

public fun setrlimit64(resource: CInt, rlim: Rlimit64?): CInt = -1
...
public fun prlimit64(pid: PidT, resource: CInt, newLimit: Rlimit64?, oldLimit: Rlimit64?): CInt = -1

public fun strerrorR(errnum: CInt, buf: String?, buflen: ULong): CInt = -1

public fun gettimeofday(tp: Timeval?, tz: Timezone?): CInt = -1

public fun mlock2(addr: COpaquePointer?, len: ULong, flags: CInt): CInt = -1
...
public fun preadv(fd: CInt, iov: Iovec?, count: CInt, offset: OffT): SsizeT = -1L

public fun pwritev(fd: CInt, iov: Iovec?, count: CInt, offset: OffT): SsizeT = -1L

public fun processVmReadv(pid: PidT, localIov: Iovec?, localIovCount: CULong, remoteIov: Iovec?, remoteIovCount: CULong, flags: CULong): SsizeT = -1L

public fun processVmWritev(pid: PidT, localIov: Iovec?, localIovCount: CULong, remoteIov: Iovec?, remoteIovCount: CULong, flags: CULong): SsizeT = -1L
...
public fun schedCpualloc(count: ULong): CpuSetT? = null

public fun schedCpufree(set: CpuSetT?) { }

public fun schedCpucount(setsize: ULong, set: CpuSetT?): CInt = -1
...
public fun utmpname(name: String?): CInt = -1
...
public fun fallocate(fd: CInt, mode: CInt, offset: OffT, len: OffT): CInt = -1
...
public fun getxattr(path: String?, name: String?, value: COpaquePointer?, size: ULong): SsizeT = -1L

public fun lgetxattr(path: String?, name: String?, value: COpaquePointer?, size: ULong): SsizeT = -1L

public fun fgetxattr(filedes: CInt, name: String?, value: COpaquePointer?, size: ULong): SsizeT = -1L
...
public fun listxattr(path: String?, list: String?, size: ULong): SsizeT = -1L

public fun llistxattr(path: String?, list: String?, size: ULong): SsizeT = -1L

public fun flistxattr(filedes: CInt, list: String?, size: ULong): SsizeT = -1L
...
public fun signalfd(fd: CInt, mask: SigsetT?, flags: CInt): CInt = -1

public fun timerfdCreate(clock: ClockidT, flags: CInt): CInt = -1

public fun timerfdGettime(fd: CInt, currentValue: Itimerspec?): CInt = -1

public fun timerfdSettime(fd: CInt, flags: CInt, newValue: Itimerspec?, oldValue: Itimerspec?): CInt = -1

public fun syscall(num: CLong, vararg args: Any?): CLong = -1L
...
public fun unshare(flags: CInt): CInt = -1

public fun umount(target: String?): CInt = -1

public fun schedGetPriorityMax(policy: CInt): CInt = -1

public fun tee(fdIn: CInt, fdOut: CInt, len: ULong, flags: CUInt): SsizeT = -1L

public fun settimeofday(tv: Timeval?, tz: Timezone?): CInt = -1

public fun splice(fdIn: CInt, offIn: LoffT?, fdOut: CInt, offOut: LoffT?, len: ULong, flags: CUInt): SsizeT = -1L
...
public fun schedRrGetInterval(pid: PidT, tp: Timespec?): CInt = -1
...
public fun setns(fd: CInt, nstype: CInt): CInt = -1

public fun swapoff(puath: String?): CInt = -1

public fun vmsplice(fd: CInt, iov: Iovec?, nrSegs: ULong, flags: CUInt): SsizeT = -1L

public fun mount(src: String?, target: String?, fstype: String?, flags: CULong, data: COpaquePointer?): CInt = -1

public fun personality(persona: CUInt): CInt = -1

public fun prctl(option: CInt, vararg args: Any?): CInt = -1
...
public fun sysinfo(info: Sysinfo?): CInt = -1

public fun umount2(target: String?, flags: CInt): CInt = -1

public fun swapon(path: String?, swapflags: CInt): CInt = -1

public fun schedSetscheduler(pid: PidT, policy: CInt, param: SchedParam?): CInt = -1

public fun sendfile(outFd: CInt, inFd: CInt, offset: OffT?, count: ULong): SsizeT = -1L

public fun sendfile64(outFd: CInt, inFd: CInt, offset: Off64T?, count: ULong): SsizeT = -1L

public fun setfsgid(gid: GidT): CInt = -1

public fun setfsuid(uid: UidT): CInt = -1
...
public fun inotifyRmWatch(fd: CInt, wd: UInt): CInt = -1

public fun inotifyInit(): CInt = -1

public fun inotifyInit1(flags: CInt): CInt = -1

public fun inotifyAddWatch(fd: CInt, path: String?, mask: UInt): CInt = -1
...
public fun androidSetAbortMessage(msg: String?) { }

public fun gettid(): PidT = -1
...
public fun systemPropertySet(name: String?, value: String?): CInt = -1

public fun systemPropertyGet(name: String?, value: String?): CInt = -1

public fun systemPropertyFind(name: String?): PropInfo? = null

public fun systemPropertyFindNth(n: CUInt): PropInfo? = null
...
public fun fwriteUnlocked(buf: COpaquePointer?, size: ULong, nobj: ULong, stream: FILE?): ULong = 0uL

public fun fflushUnlocked(stream: FILE?): CInt = -1

public fun fgetsUnlocked(buf: String?, size: CInt, stream: FILE?): String? = null

public fun klogctl(syslogType: CInt, bufp: String?, len: CInt): CInt = -1
