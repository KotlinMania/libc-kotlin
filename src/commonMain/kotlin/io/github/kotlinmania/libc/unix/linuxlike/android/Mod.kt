...
public val SECCOMP_FILTER_FLAG_TSYNC: CULong = 1 shl 0uL
public val SECCOMP_FILTER_FLAG_LOG: CULong = 1 shl 1uL
public val SECCOMP_FILTER_FLAG_SPEC_ALLOW: CULong = 1 shl 2uL
public val SECCOMP_FILTER_FLAG_NEW_LISTENER: CULong = 1 shl 3uL
public val SECCOMP_FILTER_FLAG_TSYNC_ESRCH: CULong = 1 shl 4uL
public val SECCOMP_FILTER_FLAG_WAIT_KILLABLE_RECV: CULong = 1 shl 5uL
...
public val SOF_TIMESTAMPING_TX_HARDWARE: CUInt = 1 shl 0u
public val SOF_TIMESTAMPING_TX_SOFTWARE: CUInt = 1 shl 1u
public val SOF_TIMESTAMPING_RX_HARDWARE: CUInt = 1 shl 2u
public val SOF_TIMESTAMPING_RX_SOFTWARE: CUInt = 1 shl 3u
public val SOF_TIMESTAMPING_SOFTWARE: CUInt = 1 shl 4u
public val SOF_TIMESTAMPING_SYS_HARDWARE: CUInt = 1 shl 5u
public val SOF_TIMESTAMPING_RAW_HARDWARE: CUInt = 1 shl 6u
public val SOF_TIMESTAMPING_OPT_ID: CUInt = 1 shl 7u
public val SOF_TIMESTAMPING_TX_SCHED: CUInt = 1 shl 8u
public val SOF_TIMESTAMPING_TX_ACK: CUInt = 1 shl 9u
public val SOF_TIMESTAMPING_OPT_CMSG: CUInt = 1 shl 10u
public val SOF_TIMESTAMPING_OPT_TSONLY: CUInt = 1 shl 11u
public val SOF_TIMESTAMPING_OPT_STATS: CUInt = 1 shl 12u
public val SOF_TIMESTAMPING_OPT_PKTINFO: CUInt = 1 shl 13u
public val SOF_TIMESTAMPING_OPT_TX_SWHW: CUInt = 1 shl 14u
public val SOF_TIMESTAMPING_BIND_PHC: CUInt = 1 shl 15u
public val SOF_TIMESTAMPING_OPT_ID_TCP: CUInt = 1 shl 16u
public val SOF_TIMESTAMPING_OPT_RX_FILTER: CUInt = 1 shl 17u
...
public val PR_SPEC_PRCTL: CULong = 1 shl 0uL
public val PR_SPEC_ENABLE: CULong = 1 shl 1uL
public val PR_SPEC_DISABLE: CULong = 1 shl 2uL
public val PR_SPEC_FORCE_DISABLE: CULong = 1 shl 3uL
public val PR_SPEC_DISABLE_NOEXEC: CULong = 1 shl 4uL
public const val PR_PAC_RESET_KEYS: CInt = 54
public val PR_PAC_APIAKEY: CULong = 1 shl 0uL
public val PR_PAC_APIBKEY: CULong = 1 shl 1uL
public val PR_PAC_APDAKEY: CULong = 1 shl 2uL
public val PR_PAC_APDBKEY: CULong = 1 shl 3uL
public val PR_PAC_APGAKEY: CULong = 1 shl 4uL
public const val PR_SET_TAGGED_ADDR_CTRL: CInt = 55
public const val PR_GET_TAGGED_ADDR_CTRL: CInt = 56
public val PR_TAGGED_ADDR_ENABLE: CULong = 1 shl 0uL
public const val PR_MTE_TCF_NONE: CULong = 0uL
public val PR_MTE_TCF_SYNC: CULong = 1 shl 1uL
public val PR_MTE_TCF_ASYNC: CULong = 1 shl 2uL
...
public val PR_MDWE_REFUSE_EXEC_GAIN: CULong = 1 shl 0uL
public val PR_MDWE_NO_INHERIT: CULong = 1 shl 1uL
