...
public const val CLOCK_MONOTONIC_RAW_APPROX: ClockidT = 5
public const val CLOCK_MONOTONIC: ClockidT = 6
public const val CLOCK_UPTIME_RAW: ClockidT = 8
public const val CLOCK_UPTIME_RAW_APPROX: ClockidT = 9
public const val CLOCK_PROCESS_CPUTIME_ID: ClockidT = 12
public const val CLOCK_THREAD_CPUTIME_ID: ClockidT = 16
...
public const val VM_FLAGS_ALIAS_MASK: CInt = 0xFF000000
public const val VM_FLAGS_USER_ALLOCATE: CInt = 0xff07401f
public const val VM_FLAGS_USER_MAP: CInt = 0xff97401f
...
public const val SAE_ASSOCID_ANY: SaeAssocidT = 0
public const val SAE_ASSOCID_ALL: SaeAssocidT = 0xffffffff
public const val SAE_CONNID_ANY: SaeConnidT = 0
public const val SAE_CONNID_ALL: SaeConnidT = 0xffffffff
...
public const val OS_LOG_TYPE_DEFAULT: OsLogTypeT = 0x00
public const val OS_LOG_TYPE_INFO: OsLogTypeT = 0x01
public const val OS_LOG_TYPE_DEBUG: OsLogTypeT = 0x02
public const val OS_LOG_TYPE_ERROR: OsLogTypeT = 0x10
public const val OS_LOG_TYPE_FAULT: OsLogTypeT = 0x11
public const val OS_SIGNPOST_EVENT: OsSignpostTypeT = 0x00
public const val OS_SIGNPOST_INTERVAL_BEGIN: OsSignpostTypeT = 0x01
public const val OS_SIGNPOST_INTERVAL_END: OsSignpostTypeT = 0x02
...
public const val ONOCR: TcflagT = 0x00000020
public const val ONLRET: TcflagT = 0x00000040
public const val OFILL: TcflagT = 0x00000080
public const val NLDLY: TcflagT = 0x00000300
public const val TABDLY: TcflagT = 0x00000c04
public const val CRDLY: TcflagT = 0x00003000
public const val FFDLY: TcflagT = 0x00004000
public const val BSDLY: TcflagT = 0x00008000
public const val VTDLY: TcflagT = 0x00010000
public const val OFDEL: TcflagT = 0x00020000
public const val NL0: TcflagT = 0x00000000
public const val NL1: TcflagT = 0x00000100
public const val TAB0: TcflagT = 0x00000000
public const val TAB1: TcflagT = 0x00000400
public const val TAB2: TcflagT = 0x00000800
public const val CR0: TcflagT = 0x00000000
public const val CR1: TcflagT = 0x00001000
public const val CR2: TcflagT = 0x00002000
public const val CR3: TcflagT = 0x00003000
public const val FF0: TcflagT = 0x00000000
public const val FF1: TcflagT = 0x00004000
public const val BS0: TcflagT = 0x00000000
public const val BS1: TcflagT = 0x00008000
public const val TAB3: TcflagT = 0x00000004
public const val VT0: TcflagT = 0x00000000
public const val VT1: TcflagT = 0x00010000
public const val IUTF8: TcflagT = 0x00004000
public const val CRTSCTS: TcflagT = 0x00030000
...
public const val CTLFLAG_RD: CInt = 0x80000000
...
public const val MEMORY_OBJECT_NULL: MemoryObjectT = 0
...
public val COPYFILE_ACL: CopyfileFlagsT = 1 shl 0
public val COPYFILE_STAT: CopyfileFlagsT = 1 shl 1
public val COPYFILE_XATTR: CopyfileFlagsT = 1 shl 2
public val COPYFILE_DATA: CopyfileFlagsT = 1 shl 3
...
public val COPYFILE_RECURSIVE: CopyfileFlagsT = 1 shl 15
public val COPYFILE_CHECK: CopyfileFlagsT = 1 shl 16
public val COPYFILE_EXCL: CopyfileFlagsT = 1 shl 17
public val COPYFILE_NOFOLLOW_SRC: CopyfileFlagsT = 1 shl 18
public val COPYFILE_NOFOLLOW_DST: CopyfileFlagsT = 1 shl 19
public val COPYFILE_MOVE: CopyfileFlagsT = 1 shl 20
public val COPYFILE_UNLINK: CopyfileFlagsT = 1 shl 21
public val COPYFILE_PACK: CopyfileFlagsT = 1 shl 22
public val COPYFILE_UNPACK: CopyfileFlagsT = 1 shl 23
public val COPYFILE_CLONE: CopyfileFlagsT = 1 shl 24
public val COPYFILE_CLONE_FORCE: CopyfileFlagsT = 1 shl 25
public val COPYFILE_RUN_IN_PLACE: CopyfileFlagsT = 1 shl 26
public val COPYFILE_DATA_SPARSE: CopyfileFlagsT = 1 shl 27
public val COPYFILE_PRESERVE_DST_TRACKED: CopyfileFlagsT = 1 shl 28
public val COPYFILE_VERBOSE: CopyfileFlagsT = 1 shl 30
...
public const val ATTR_CMN_NAME: AttrgroupT = 0x00000001
public const val ATTR_CMN_DEVID: AttrgroupT = 0x00000002
public const val ATTR_CMN_FSID: AttrgroupT = 0x00000004
public const val ATTR_CMN_OBJTYPE: AttrgroupT = 0x00000008
public const val ATTR_CMN_OBJTAG: AttrgroupT = 0x00000010
public const val ATTR_CMN_OBJID: AttrgroupT = 0x00000020
public const val ATTR_CMN_OBJPERMANENTID: AttrgroupT = 0x00000040
public const val ATTR_CMN_PAROBJID: AttrgroupT = 0x00000080
public const val ATTR_CMN_SCRIPT: AttrgroupT = 0x00000100
public const val ATTR_CMN_CRTIME: AttrgroupT = 0x00000200
public const val ATTR_CMN_MODTIME: AttrgroupT = 0x00000400
public const val ATTR_CMN_CHGTIME: AttrgroupT = 0x00000800
public const val ATTR_CMN_ACCTIME: AttrgroupT = 0x00001000
public const val ATTR_CMN_BKUPTIME: AttrgroupT = 0x00002000
public const val ATTR_CMN_FNDRINFO: AttrgroupT = 0x00004000
public const val ATTR_CMN_OWNERID: AttrgroupT = 0x00008000
public const val ATTR_CMN_GRPID: AttrgroupT = 0x00010000
public const val ATTR_CMN_ACCESSMASK: AttrgroupT = 0x00020000
public const val ATTR_CMN_FLAGS: AttrgroupT = 0x00040000
public const val ATTR_CMN_GEN_COUNT: AttrgroupT = 0x00080000
public const val ATTR_CMN_DOCUMENT_ID: AttrgroupT = 0x00100000
public const val ATTR_CMN_USERACCESS: AttrgroupT = 0x00200000
public const val ATTR_CMN_EXTENDED_SECURITY: AttrgroupT = 0x00400000
public const val ATTR_CMN_UUID: AttrgroupT = 0x00800000
public const val ATTR_CMN_GRPUUID: AttrgroupT = 0x01000000
public const val ATTR_CMN_FILEID: AttrgroupT = 0x02000000
public const val ATTR_CMN_PARENTID: AttrgroupT = 0x04000000
public const val ATTR_CMN_FULLPATH: AttrgroupT = 0x08000000
public const val ATTR_CMN_ADDEDTIME: AttrgroupT = 0x10000000
public const val ATTR_CMN_DATA_PROTECT_FLAGS: AttrgroupT = 0x40000000
public const val ATTR_CMN_RETURNED_ATTRS: AttrgroupT = 0x80000000
public const val ATTR_VOL_FSTYPE: AttrgroupT = 0x00000001
public const val ATTR_VOL_SIGNATURE: AttrgroupT = 0x00000002
public const val ATTR_VOL_SIZE: AttrgroupT = 0x00000004
public const val ATTR_VOL_SPACEFREE: AttrgroupT = 0x00000008
public const val ATTR_VOL_SPACEAVAIL: AttrgroupT = 0x00000010
public const val ATTR_VOL_MINALLOCATION: AttrgroupT = 0x00000020
public const val ATTR_VOL_ALLOCATIONCLUMP: AttrgroupT = 0x00000040
public const val ATTR_VOL_IOBLOCKSIZE: AttrgroupT = 0x00000080
public const val ATTR_VOL_OBJCOUNT: AttrgroupT = 0x00000100
public const val ATTR_VOL_FILECOUNT: AttrgroupT = 0x00000200
public const val ATTR_VOL_DIRCOUNT: AttrgroupT = 0x00000400
public const val ATTR_VOL_MAXOBJCOUNT: AttrgroupT = 0x00000800
public const val ATTR_VOL_MOUNTPOINT: AttrgroupT = 0x00001000
public const val ATTR_VOL_NAME: AttrgroupT = 0x00002000
public const val ATTR_VOL_MOUNTFLAGS: AttrgroupT = 0x00004000
public const val ATTR_VOL_MOUNTEDDEVICE: AttrgroupT = 0x00008000
public const val ATTR_VOL_ENCODINGSUSED: AttrgroupT = 0x00010000
public const val ATTR_VOL_CAPABILITIES: AttrgroupT = 0x00020000
public const val ATTR_VOL_UUID: AttrgroupT = 0x00040000
public const val ATTR_VOL_SPACEUSED: AttrgroupT = 0x00800000
public const val ATTR_VOL_QUOTA_SIZE: AttrgroupT = 0x10000000
public const val ATTR_VOL_RESERVED_SIZE: AttrgroupT = 0x20000000
public const val ATTR_VOL_ATTRIBUTES: AttrgroupT = 0x40000000
public const val ATTR_VOL_INFO: AttrgroupT = 0x80000000
public const val ATTR_DIR_LINKCOUNT: AttrgroupT = 0x00000001
public const val ATTR_DIR_ENTRYCOUNT: AttrgroupT = 0x00000002
public const val ATTR_DIR_MOUNTSTATUS: AttrgroupT = 0x00000004
public const val ATTR_DIR_ALLOCSIZE: AttrgroupT = 0x00000008
public const val ATTR_DIR_IOBLOCKSIZE: AttrgroupT = 0x00000010
public const val ATTR_DIR_DATALENGTH: AttrgroupT = 0x00000020
public const val ATTR_FILE_LINKCOUNT: AttrgroupT = 0x00000001
public const val ATTR_FILE_TOTALSIZE: AttrgroupT = 0x00000002
public const val ATTR_FILE_ALLOCSIZE: AttrgroupT = 0x00000004
public const val ATTR_FILE_IOBLOCKSIZE: AttrgroupT = 0x00000008
public const val ATTR_FILE_DEVTYPE: AttrgroupT = 0x00000020
public const val ATTR_FILE_FORKCOUNT: AttrgroupT = 0x00000080
public const val ATTR_FILE_FORKLIST: AttrgroupT = 0x00000100
public const val ATTR_FILE_DATALENGTH: AttrgroupT = 0x00000200
public const val ATTR_FILE_DATAALLOCSIZE: AttrgroupT = 0x00000400
public const val ATTR_FILE_RSRCLENGTH: AttrgroupT = 0x00001000
public const val ATTR_FILE_RSRCALLOCSIZE: AttrgroupT = 0x00002000
public const val ATTR_CMNEXT_RELPATH: AttrgroupT = 0x00000004
public const val ATTR_CMNEXT_PRIVATESIZE: AttrgroupT = 0x00000008
public const val ATTR_CMNEXT_LINKID: AttrgroupT = 0x00000010
public const val ATTR_CMNEXT_NOFIRMLINKPATH: AttrgroupT = 0x00000020
public const val ATTR_CMNEXT_REALDEVID: AttrgroupT = 0x00000040
public const val ATTR_CMNEXT_REALFSID: AttrgroupT = 0x00000080
public const val ATTR_CMNEXT_CLONEID: AttrgroupT = 0x00000100
public const val ATTR_CMNEXT_EXT_FLAGS: AttrgroupT = 0x00000200
public const val ATTR_CMNEXT_RECURSIVE_GENCOUNT: AttrgroupT = 0x00000400
...
public const val VOL_CAP_FMT_PERSISTENTOBJECTIDS: AttrgroupT = 0x00000001
public const val VOL_CAP_FMT_SYMBOLICLINKS: AttrgroupT = 0x00000002
public const val VOL_CAP_FMT_HARDLINKS: AttrgroupT = 0x00000004
public const val VOL_CAP_FMT_JOURNAL: AttrgroupT = 0x00000008
public const val VOL_CAP_FMT_JOURNAL_ACTIVE: AttrgroupT = 0x00000010
public const val VOL_CAP_FMT_NO_ROOT_TIMES: AttrgroupT = 0x00000020
public const val VOL_CAP_FMT_SPARSE_FILES: AttrgroupT = 0x00000040
public const val VOL_CAP_FMT_ZERO_RUNS: AttrgroupT = 0x00000080
public const val VOL_CAP_FMT_CASE_SENSITIVE: AttrgroupT = 0x00000100
public const val VOL_CAP_FMT_CASE_PRESERVING: AttrgroupT = 0x00000200
public const val VOL_CAP_FMT_FAST_STATFS: AttrgroupT = 0x00000400
public const val VOL_CAP_FMT_2TB_FILESIZE: AttrgroupT = 0x00000800
public const val VOL_CAP_FMT_OPENDENYMODES: AttrgroupT = 0x00001000
public const val VOL_CAP_FMT_HIDDEN_FILES: AttrgroupT = 0x00002000
public const val VOL_CAP_FMT_PATH_FROM_ID: AttrgroupT = 0x00004000
public const val VOL_CAP_FMT_NO_VOLUME_SIZES: AttrgroupT = 0x00008000
public const val VOL_CAP_FMT_DECMPFS_COMPRESSION: AttrgroupT = 0x00010000
public const val VOL_CAP_FMT_64BIT_OBJECT_IDS: AttrgroupT = 0x00020000
public const val VOL_CAP_FMT_DIR_HARDLINKS: AttrgroupT = 0x00040000
public const val VOL_CAP_FMT_DOCUMENT_ID: AttrgroupT = 0x00080000
public const val VOL_CAP_FMT_WRITE_GENERATION_COUNT: AttrgroupT = 0x00100000
public const val VOL_CAP_FMT_NO_IMMUTABLE_FILES: AttrgroupT = 0x00200000
public const val VOL_CAP_FMT_NO_PERMISSIONS: AttrgroupT = 0x00400000
public const val VOL_CAP_FMT_SHARED_SPACE: AttrgroupT = 0x00800000
public const val VOL_CAP_FMT_VOL_GROUPS: AttrgroupT = 0x01000000
public const val VOL_CAP_FMT_SEALED: AttrgroupT = 0x02000000
public const val VOL_CAP_INT_SEARCHFS: AttrgroupT = 0x00000001
public const val VOL_CAP_INT_ATTRLIST: AttrgroupT = 0x00000002
public const val VOL_CAP_INT_NFSEXPORT: AttrgroupT = 0x00000004
public const val VOL_CAP_INT_READDIRATTR: AttrgroupT = 0x00000008
public const val VOL_CAP_INT_EXCHANGEDATA: AttrgroupT = 0x00000010
public const val VOL_CAP_INT_COPYFILE: AttrgroupT = 0x00000020
public const val VOL_CAP_INT_ALLOCATE: AttrgroupT = 0x00000040
public const val VOL_CAP_INT_VOL_RENAME: AttrgroupT = 0x00000080
public const val VOL_CAP_INT_ADVLOCK: AttrgroupT = 0x00000100
public const val VOL_CAP_INT_FLOCK: AttrgroupT = 0x00000200
public const val VOL_CAP_INT_EXTENDED_SECURITY: AttrgroupT = 0x00000400
public const val VOL_CAP_INT_USERACCESS: AttrgroupT = 0x00000800
public const val VOL_CAP_INT_MANLOCK: AttrgroupT = 0x00001000
public const val VOL_CAP_INT_NAMEDSTREAMS: AttrgroupT = 0x00002000
public const val VOL_CAP_INT_EXTENDED_ATTR: AttrgroupT = 0x00004000
public const val VOL_CAP_INT_CLONE: AttrgroupT = 0x00010000
public const val VOL_CAP_INT_SNAPSHOT: AttrgroupT = 0x00020000
public const val VOL_CAP_INT_RENAME_SWAP: AttrgroupT = 0x00040000
public const val VOL_CAP_INT_RENAME_EXCL: AttrgroupT = 0x00080000
public const val VOL_CAP_INT_RENAME_OPENFAIL: AttrgroupT = 0x00100000
public const val OS_CLOCK_MACH_ABSOLUTE_TIME: OsClockidT = 32
public const val OS_SYNC_WAIT_ON_ADDRESS_NONE: OsSyncWaitOnAddressFlagsT = 0x00000000
public const val OS_SYNC_WAIT_ON_ADDRESS_SHARED: OsSyncWaitOnAddressFlagsT = 0x00000001
public const val OS_SYNC_WAKE_BY_ADDRESS_NONE: OsSyncWakeByAddressFlagsT = 0x00000000
public const val OS_SYNC_WAKE_BY_ADDRESS_SHARED: OsSyncWakeByAddressFlagsT = 0x00000001
