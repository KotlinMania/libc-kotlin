...
public const val P_PPID: IdtypeT = 1
public const val P_PGID: IdtypeT = 2
public const val P_SID: IdtypeT = 3
public const val P_CID: IdtypeT = 4
public const val P_UID: IdtypeT = 5
public const val P_GID: IdtypeT = 6
public const val P_ALL: IdtypeT = 7
public const val P_LWPID: IdtypeT = 8
public const val P_TASKID: IdtypeT = 9
public const val P_PROJID: IdtypeT = 10
public const val P_POOLID: IdtypeT = 11
public const val P_ZONEID: IdtypeT = 12
public const val P_CTID: IdtypeT = 13
public const val P_CPUID: IdtypeT = 14
public const val P_PSETID: IdtypeT = 15
...
public const val RLIM_NLIMITS: RlimT = 7
...
public const val B76800: SpeedT = 17
public const val B115200: SpeedT = 18
public const val B153600: SpeedT = 19
public const val B230400: SpeedT = 20
public const val B307200: SpeedT = 21
public const val B460800: SpeedT = 22
public const val B921600: SpeedT = 23
public const val CSTART: TcflagT = 17
public const val CSTOP: TcflagT = 19
public const val CSWTCH: TcflagT = 26
public const val CBAUD: TcflagT = 15
public const val CIBAUD: TcflagT = 983040
public const val CBAUDEXT: TcflagT = 2097152
public const val CIBAUDEXT: TcflagT = 4194304
...
public const val DOSMODE: TcflagT = 32768
...
public const val CRTSXOFF: TcflagT = 1073741824
public const val CRTSCTS: TcflagT = 2147483648
...
public const val FLUSHO: TcflagT = 8192
...
public const val LGRP_COOKIE_NONE: LgrpCookieT = 0
...
public const val LGRP_CONTENT_ALL: LgrpContentT = 0
public const val LGRP_CONTENT_HIERARCHY: LgrpContentT = LGRP_CONTENT_ALL
public const val LGRP_CONTENT_DIRECT: LgrpContentT = 1
public const val LGRP_LAT_CPU_TO_MEM: LgrpLatBetweenT = 0
public const val LGRP_MEM_SZ_FREE: LgrpMemSizeFlagT = 0
public const val LGRP_MEM_SZ_INSTALLED: LgrpMemSizeFlagT = 1
public const val LGRP_VIEW_CALLER: LgrpViewT = 0
public const val LGRP_VIEW_OS: LgrpViewT = 1
