// port-lint: source libc/src/unix/linux_like/linux/gnu/b32/m68k/mod.rs
package io.github.kotlinmania.libc.unix.linuxlike.linux.gnu.b32.m68k
...
public const val O_LARGEFILE: CInt = 0x20000
...
public const val SYS_time32: CLong = 13
public const val SYS_mknod: CLong = 14
public const val SYS_chmod: CLong = 15
public const val SYS_chown16: CLong = 16
public const val SYS_stat: CLong = 18
public const val SYS_lseek: CLong = 19
public const val SYS_getpid: CLong = 20
public const val SYS_mount: CLong = 21
public const val SYS_oldumount: CLong = 22
public const val SYS_setuid16: CLong = 23
public const val SYS_getuid16: CLong = 24
public const val SYS_stime32: CLong = 25
public const val SYS_ptrace: CLong = 26
public const val SYS_alarm: CLong = 27
public const val SYS_fstat: CLong = 28
public const val SYS_pause: CLong = 29
public const val SYS_utime32: CLong = 30
...
public const val SYS_setgid16: CLong = 46
public const val SYS_getgid16: CLong = 47
public const val SYS_signal: CLong = 48
public const val SYS_geteuid16: CLong = 49
public const val SYS_getegid16: CLong = 50
public const val SYS_acct: CLong = 51
public const val SYS_umount: CLong = 52
...
public const val SYS_setreuid16: CLong = 70
public const val SYS_setregid16: CLong = 71
...
public const val SYS_old_getrlimit: CLong = 76
...
public const val SYS_getgroups16: CLong = 80
public const val SYS_setgroups16: CLong = 81
public const val SYS_old_select: CLong = 82
public const val SYS_symlink: CLong = 83
public const val SYS_lstat: CLong = 84
...
public const val SYS_old_readdir: CLong = 89
public const val SYS_old_mmap: CLong = 90
...
public const val SYS_fchown16: CLong = 95
...
public const val SYS_newstat: CLong = 106
public const val SYS_newlstat: CLong = 107
public const val SYS_newfstat: CLong = 108
...
public const val SYS_newuname: CLong = 122
public const val SYS_cacheflush: CLong = 123
public const val SYS_adjtimex_time32: CLong = 124
...
public const val SYS_setfsuid16: CLong = 138
public const val SYS_setfsgid16: CLong = 139
public const val SYS_llseek: CLong = 140
...
public const val SYS_sched_rr_get_interval_time32: CLong = 161
public const val SYS_nanosleep_time32: CLong = 162
public const val SYS_mremap: CLong = 163
public const val SYS_setresuid16: CLong = 164
public const val SYS_getresuid16: CLong = 165
public const val SYS_getpagesize: CLong = 166
public const val SYS_query_module: CLong = 167
public const val SYS_poll: CLong = 168
public const val SYS_nfsservctl: CLong = 169
public const val SYS_setresgid16: CLong = 170
public const val SYS_getresgid16: CLong = 171
...
public const val SYS_rt_sigtimedwait_time32: CLong = 177
...
public const val SYS_lchown16: CLong = 182
...
public const val SYS_chown: CLong = 198
...
public const val SYS_lchown: CLong = 212
...
public const val SYS_gettid: CLong = 221
public const val SYS_tkill: CLong = 222
public const val SYS_setxattr: CLong = 223
public const val SYS_lsetxattr: CLong = 224
public const val SYS_fsetxattr: CLong = 225
public const val SYS_getxattr: CLong = 226
public const val SYS_lgetxattr: CLong = 227
public const val SYS_fgetxattr: CLong = 228
public const val SYS_listxattr: CLong = 229
public const val SYS_llistxattr: CLong = 230
public const val SYS_flistxattr: CLong = 231
public const val SYS_removexattr: CLong = 232
public const val SYS_lremovexattr: CLong = 233
public const val SYS_fremovexattr: CLong = 234
public const val SYS_futex_time32: CLong = 235
public const val SYS_sendfile64: CLong = 236
public const val SYS_mincore: CLong = 237
public const val SYS_madvise: CLong = 238
public const val SYS_fcntl64: CLong = 239
public const val SYS_readahead: CLong = 240
public const val SYS_io_setup: CLong = 241
public const val SYS_io_destroy: CLong = 242
public const val SYS_io_getevents_time32: CLong = 243
public const val SYS_io_submit: CLong = 244
public const val SYS_io_cancel: CLong = 245
public const val SYS_fadvise64: CLong = 246
public const val SYS_exit_group: CLong = 247
public const val SYS_lookup_dcookie: CLong = 248
...
public const val SYS_remap_file_pages: CLong = 252
public const val SYS_set_tid_address: CLong = 253
public const val SYS_timer_create: CLong = 254
public const val SYS_timer_settime32: CLong = 255
public const val SYS_timer_gettime32: CLong = 256
public const val SYS_timer_getoverrun: CLong = 257
public const val SYS_timer_delete: CLong = 258
public const val SYS_clock_settime32: CLong = 259
public const val SYS_clock_gettime32: CLong = 260
public const val SYS_clock_getres_time32: CLong = 261
public const val SYS_clock_nanosleep_time32: CLong = 262
public const val SYS_statfs64: CLong = 263
public const val SYS_fstatfs64: CLong = 264
public const val SYS_tgkill: CLong = 265
public const val SYS_utimes_time32: CLong = 266
public const val SYS_fadvise64_64: CLong = 267
...
public const val SYS_mq_timedsend_time32: CLong = 273
public const val SYS_mq_timedreceive_time32: CLong = 274
public const val SYS_mq_notify: CLong = 275
public const val SYS_mq_getsetattr: CLong = 276
public const val SYS_waitid: CLong = 277
public const val SYS_add_key: CLong = 279
public const val SYS_request_key: CLong = 280
public const val SYS_keyctl: CLong = 281
...
public const val SYS_futimesat_time32: CLong = 292
public const val SYS_fstatat64: CLong = 293
...
public const val SYS_pselect6_time32: CLong = 301
public const val SYS_ppoll_time32: CLong = 302
...
public const val SYS_sched_setaffinity: CLong = 311
public const val SYS_sched_getaffinity: CLong = 312
public const val SYS_kexec_load: CLong = 313
public const val SYS_getcpu: CLong = 314
public const val SYS_epoll_pwait: CLong = 315
public const val SYS_utimensat_time32: CLong = 316
public const val SYS_signalfd: CLong = 317
public const val SYS_timerfd_create: CLong = 318
public const val SYS_eventfd: CLong = 319
public const val SYS_fallocate: CLong = 320
public const val SYS_timerfd_settime32: CLong = 321
public const val SYS_timerfd_gettime32: CLong = 322
public const val SYS_signalfd4: CLong = 323
public const val SYS_eventfd2: CLong = 324
public const val SYS_epoll_create1: CLong = 325
public const val SYS_dup3: CLong = 326
public const val SYS_pipe2: CLong = 327
public const val SYS_inotify_init1: CLong = 328
public const val SYS_preadv: CLong = 329
public const val SYS_pwritev: CLong = 330
public const val SYS_rt_tgsigqueueinfo: CLong = 331
public const val SYS_perf_event_open: CLong = 332
public const val SYS_get_thread_area: CLong = 333
public const val SYS_set_thread_area: CLong = 334
public const val SYS_atomic_cmpxchg_32: CLong = 335
public const val SYS_atomic_barrier: CLong = 336
public const val SYS_fanotify_init: CLong = 337
public const val SYS_fanotify_mark: CLong = 338
public const val SYS_prlimit64: CLong = 339
public const val SYS_name_to_handle_at: CLong = 340
public const val SYS_open_by_handle_at: CLong = 341
public const val SYS_clock_adjtime32: CLong = 342
public const val SYS_syncfs: CLong = 343
public const val SYS_setns: CLong = 344
public const val SYS_process_vm_readv: CLong = 345
public const val SYS_process_vm_writev: CLong = 346
public const val SYS_kcmp: CLong = 347
public const val SYS_finit_module: CLong = 348
public const val SYS_sched_setattr: CLong = 349
public const val SYS_sched_getattr: CLong = 350
public const val SYS_renameat2: CLong = 351
public const val SYS_getrandom: CLong = 352
public const val SYS_memfd_create: CLong = 353
public const val SYS_bpf: CLong = 354
public const val SYS_execveat: CLong = 355
public const val SYS_socket: CLong = 356
public const val SYS_socketpair: CLong = 357
public const val SYS_bind: CLong = 358
public const val SYS_connect: CLong = 359
public const val SYS_listen: CLong = 360
public const val SYS_accept4: CLong = 361
public const val SYS_getsockopt: CLong = 362
public const val SYS_setsockopt: CLong = 363
public const val SYS_getsockname: CLong = 364
public const val SYS_getpeername: CLong = 365
public const val SYS_sendto: CLong = 366
public const val SYS_sendmsg: CLong = 367
public const val SYS_recvfrom: CLong = 368
public const val SYS_recvmsg: CLong = 369
public const val SYS_shutdown: CLong = 370
public const val SYS_recvmmsg_time32: CLong = 371
public const val SYS_sendmmsg: CLong = 372
public const val SYS_userfaultfd: CLong = 373
public const val SYS_membarrier: CLong = 374
public const val SYS_mlock2: CLong = 375
public const val SYS_copy_file_range: CLong = 376
public const val SYS_preadv2: CLong = 377
public const val SYS_pwritev2: CLong = 378
public const val SYS_statx: CLong = 379
public const val SYS_seccomp: CLong = 380
public const val SYS_pkey_mprotect: CLong = 381
public const val SYS_pkey_alloc: CLong = 382
public const val SYS_pkey_free: CLong = 383
public const val SYS_rseq: CLong = 384
...
public const val SYS_clock_gettime: CLong = 403
public const val SYS_clock_settime: CLong = 404
public const val SYS_clock_adjtime: CLong = 405
public const val SYS_clock_getres: CLong = 406
public const val SYS_clock_nanosleep: CLong = 407
public const val SYS_timer_gettime: CLong = 408
public const val SYS_timer_settime: CLong = 409
public const val SYS_timerfd_gettime: CLong = 410
public const val SYS_timerfd_settime: CLong = 411
public const val SYS_utimensat: CLong = 412
public const val SYS_pselect6: CLong = 413
public const val SYS_ppoll: CLong = 414
public const val SYS_io_pgetevents: CLong = 416
public const val SYS_recvmmsg: CLong = 417
public const val SYS_mq_timedsend: CLong = 418
public const val SYS_mq_timedreceive: CLong = 419
public const val SYS_semtimedop: CLong = 420
public const val SYS_rt_sigtimedwait: CLong = 421
public const val SYS_futex: CLong = 422
public const val SYS_sched_rr_get_interval: CLong = 423
...
public const val SYS_map_shadow_stack: CLong = 453
public const val SYS_futex_wake: CLong = 454
public const val SYS_futex_wait: CLong = 455
public const val SYS_futex_requeue: CLong = 456
public const val SYS_statmount: CLong = 457
public const val SYS_listmount: CLong = 458
public const val SYS_lsm_get_self_attr: CLong = 459
public const val SYS_lsm_set_self_attr: CLong = 460
public const val SYS_lsm_list_modules: CLong = 461
public const val SYS_mseal: CLong = 462
public const val SYS_setxattrat: CLong = 463
public const val SYS_getxattrat: CLong = 464
public const val SYS_listxattrat: CLong = 465
public const val SYS_removexattrat: CLong = 466
public const val SYS_open_tree_attr: CLong = 467
public const val SYS_file_get_attr: CLong = 468
public const val SYS_file_set_attr: CLong = 469
