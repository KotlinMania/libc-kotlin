// port-lint: source libc/src/unix/linux_like/linux/musl/b32/x86/mod.rs
package io.github.kotlinmania.libc.unix.linuxlike.linux.musl.b32.x86
...
public data class ShmidDs(
    val shmPerm: IpcPerm,
    val shmSegsz: ULong,
    val shmAtimeLo: CULong,
    val shmAtimeHi: CULong,
    val shmDtimeLo: CULong,
    val shmDtimeHi: CULong,
    val msgCtimeLo: CULong,
    val msgCtimeHi: CULong,
    val shmAtime: TimeT,
    val shmDtime: TimeT,
    val shmCtime: TimeT,
    val shmCpid: PidT,
...
public data class MsqidDs(
    val msgPerm: IpcPerm,
    val msgStimeLo: CULong,
    val msgStimeHi: CULong,
    val msgRtimeLo: CULong,
    val msgRtimeHi: CULong,
    val msgCtimeLo: CULong,
    val msgCtimeHi: CULong,
    val msgStime: TimeT,
    val msgRtime: TimeT,
