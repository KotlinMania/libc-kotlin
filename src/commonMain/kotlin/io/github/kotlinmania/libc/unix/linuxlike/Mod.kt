...
public val TUNATTACHFILTER: Ioctl = ioctlCode<SockFprog>(T_TYPE, 213.toUInt())
public val TUNDETACHFILTER: Ioctl = ioctlCode<SockFprog>(T_TYPE, 214.toUInt())
...
public val TUNGETFILTER: Ioctl = ioctlCode<SockFprog>(T_TYPE, 219.toUInt())
...
public val FS_IOC_GETFLAGS: Ioctl = ioctlCode<CLong>('f'.code.toUInt(), 1.toUInt())
public val FS_IOC_SETFLAGS: Ioctl = ioctlCode<CLong>('f'.code.toUInt(), 2.toUInt())
public val FS_IOC_GETVERSION: Ioctl = ioctlCode<CLong>('v'.code.toUInt(), 1.toUInt())
public val FS_IOC_SETVERSION: Ioctl = ioctlCode<CLong>('v'.code.toUInt(), 2.toUInt())
public val FS_IOC32_GETFLAGS: Ioctl = ioctlCode<CInt>('f'.code.toUInt(), 1.toUInt())
public val FS_IOC32_SETFLAGS: Ioctl = ioctlCode<CInt>('f'.code.toUInt(), 2.toUInt())
public val FS_IOC32_GETVERSION: Ioctl = ioctlCode<CInt>('v'.code.toUInt(), 1.toUInt())
public val FS_IOC32_SETVERSION: Ioctl = ioctlCode<CInt>('v'.code.toUInt(), 2.toUInt())
public val FICLONE: Ioctl = ioctlCode<CInt>(0x94.toUInt(), 9.toUInt())
public val FICLONERANGE: Ioctl = ioctlCode<FileCloneRange>(0x94.toUInt(), 13.toUInt())
