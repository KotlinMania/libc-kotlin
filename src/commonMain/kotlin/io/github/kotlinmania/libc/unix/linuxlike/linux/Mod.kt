...
public enum class TpacketVersions(public val value: UInt) {
    TPACKET_V1(0u),
    TPACKET_V2(1u),
    TPACKET_V3(2u),
    ;
...
public const val IFA_FLAGS: CUShort = 8u
...
public val RB_AUTOBOOT: CInt = 0x01234567u32.toInt()
public val RB_HALT_SYSTEM: CInt = 0xcdef0123u32.toInt()
public val RB_ENABLE_CAD: CInt = 0x89abcdefu32.toInt()
public val RB_DISABLE_CAD: CInt = 0x00000000u32.toInt()
public val RB_POWER_OFF: CInt = 0x4321fedcu32.toInt()
public val RB_SW_SUSPEND: CInt = 0xd000fce2u32.toInt()
public val RB_KEXEC: CInt = 0x45584543u32.toInt()
...
public const val NS_GET_USERNS: Ioctl = _IO(NSIO, 0x1)
...
public const val NS_GET_TGID_IN_PIDNS: Ioctl = <c_int>(NSIO, 0x9)
public const val MNT_NS_INFO_SIZE_VER0: Ioctl = 16
public const val NS_MNT_GET_INFO: Ioctl = <mnt_ns_info>(NSIO, 10)
public const val NS_MNT_GET_NEXT: Ioctl = <mnt_ns_info>(NSIO, 11)
public const val NS_MNT_GET_PREV: Ioctl = <mnt_ns_info>(NSIO, 12)
public val PIDFD_NONBLOCK: CUInt = O_NONBLOCK.toUInt()
public val PIDFD_THREAD: CUInt = O_EXCL.toUInt()
public val PIDFD_SIGNAL_THREAD: CUInt = 1 shl 0
public val PIDFD_SIGNAL_THREAD_GROUP: CUInt = 1 shl 1
public val PIDFD_SIGNAL_PROCESS_GROUP: CUInt = 1 shl 2
public val PIDFD_INFO_PID: CUInt = 1 shl 0
public val PIDFD_INFO_CREDS: CUInt = 1 shl 1
public val PIDFD_INFO_CGROUPID: CUInt = 1 shl 2
public val PIDFD_INFO_EXIT: CUInt = 1 shl 3
public const val PIDFD_INFO_SIZE_VER0: CUInt = 64u
public const val PIDFD_GET_CGROUP_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 1)
public const val PIDFD_GET_IPC_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 2)
public const val PIDFD_GET_MNT_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 3)
public const val PIDFD_GET_NET_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 4)
public const val PIDFD_GET_PID_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 5)
public const val PIDFD_GET_PID_FOR_CHILDREN_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 6)
public const val PIDFD_GET_TIME_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 7)
public const val PIDFD_GET_TIME_FOR_CHILDREN_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 8)
public const val PIDFD_GET_USER_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 9)
public const val PIDFD_GET_UTS_NAMESPACE: Ioctl = _IO(PIDFS_IOCTL_MAGIC, 10)
public const val PIDFD_GET_INFO: Ioctl = <pidfd_info>(PIDFS_IOCTL_MAGIC, 11)
public const val PR_SET_MDWE: CInt = 65
public const val PR_GET_MDWE: CInt = 66
public val PR_MDWE_REFUSE_EXEC_GAIN: CUInt = 1 shl 0
public val PR_MDWE_NO_INHERIT: CUInt = 1 shl 1
...
public val CLOSE_RANGE_UNSHARE: CUInt = 1 shl 1
public val CLOSE_RANGE_CLOEXEC: CUInt = 1 shl 2
...
public val TP_STATUS_CSUMNOTREADY: U32 = 1 shl 3
public val TP_STATUS_VLAN_VALID: U32 = 1 shl 4
...
public val SOF_TXTIME_DEADLINE_MODE: UInt = 1 shl 0
public val SOF_TXTIME_REPORT_ERRORS: UInt = 1 shl 1
...
public const val PTP_CLOCK_GETCAPS: Ioctl = <ptp_clock_caps>(PTP_CLK_MAGIC, 1)
public const val PTP_EXTTS_REQUEST: Ioctl = <ptp_extts_request>(PTP_CLK_MAGIC, 2)
public const val PTP_PEROUT_REQUEST: Ioctl = <ptp_perout_request>(PTP_CLK_MAGIC, 3)
public const val PTP_ENABLE_PPS: Ioctl = <c_int>(PTP_CLK_MAGIC, 4)
public const val PTP_SYS_OFFSET: Ioctl = <ptp_sys_offset>(PTP_CLK_MAGIC, 5)
public const val PTP_PIN_GETFUNC: Ioctl = <ptp_pin_desc>(PTP_CLK_MAGIC, 6)
public const val PTP_PIN_SETFUNC: Ioctl = <ptp_pin_desc>(PTP_CLK_MAGIC, 7)
public const val PTP_SYS_OFFSET_PRECISE: Ioctl = <ptp_sys_offset_precise>(PTP_CLK_MAGIC, 8)
public const val PTP_SYS_OFFSET_EXTENDED: Ioctl = <ptp_sys_offset_extended>(PTP_CLK_MAGIC, 9)
public const val PTP_CLOCK_GETCAPS2: Ioctl = <ptp_clock_caps>(PTP_CLK_MAGIC, 10)
public const val PTP_EXTTS_REQUEST2: Ioctl = <ptp_extts_request>(PTP_CLK_MAGIC, 11)
public const val PTP_PEROUT_REQUEST2: Ioctl = <ptp_perout_request>(PTP_CLK_MAGIC, 12)
public const val PTP_ENABLE_PPS2: Ioctl = <c_int>(PTP_CLK_MAGIC, 13)
public const val PTP_SYS_OFFSET2: Ioctl = <ptp_sys_offset>(PTP_CLK_MAGIC, 14)
public const val PTP_PIN_GETFUNC2: Ioctl = <ptp_pin_desc>(PTP_CLK_MAGIC, 15)
public const val PTP_PIN_SETFUNC2: Ioctl = <ptp_pin_desc>(PTP_CLK_MAGIC, 16)
public const val PTP_SYS_OFFSET_PRECISE2: Ioctl = <ptp_sys_offset_precise>(PTP_CLK_MAGIC, 17)
public const val PTP_SYS_OFFSET_EXTENDED2: Ioctl = <ptp_sys_offset_extended>(PTP_CLK_MAGIC, 18)
...
public const val SECBIT_NOROOT: CInt = issecure_mask(SECURE_NOROOT)
public const val SECBIT_NOROOT_LOCKED: CInt = issecure_mask(SECURE_NOROOT_LOCKED)
public const val SECBIT_NO_SETUID_FIXUP: CInt = issecure_mask(SECURE_NO_SETUID_FIXUP)
public const val SECBIT_NO_SETUID_FIXUP_LOCKED: CInt = issecure_mask(SECURE_NO_SETUID_FIXUP_LOCKED)
public const val SECBIT_KEEP_CAPS: CInt = issecure_mask(SECURE_KEEP_CAPS)
public const val SECBIT_KEEP_CAPS_LOCKED: CInt = issecure_mask(SECURE_KEEP_CAPS_LOCKED)
public const val SECBIT_NO_CAP_AMBIENT_RAISE: CInt = issecure_mask(SECURE_NO_CAP_AMBIENT_RAISE)
public const val SECBIT_EXEC_RESTRICT_FILE: CInt = issecure_mask(SECURE_EXEC_RESTRICT_FILE)
public const val SECBIT_EXEC_RESTRICT_FILE_LOCKED: CInt = issecure_mask(SECURE_EXEC_RESTRICT_FILE_LOCKED)
public const val SECBIT_EXEC_DENY_INTERACTIVE: CInt = issecure_mask(SECURE_EXEC_DENY_INTERACTIVE)
...
public const val FAN_ACCESS: ULong = 0x0000_0001
public const val FAN_MODIFY: ULong = 0x0000_0002
public const val FAN_ATTRIB: ULong = 0x0000_0004
public const val FAN_CLOSE_WRITE: ULong = 0x0000_0008
public const val FAN_CLOSE_NOWRITE: ULong = 0x0000_0010
public const val FAN_OPEN: ULong = 0x0000_0020
public const val FAN_MOVED_FROM: ULong = 0x0000_0040
public const val FAN_MOVED_TO: ULong = 0x0000_0080
public const val FAN_CREATE: ULong = 0x0000_0100
public const val FAN_DELETE: ULong = 0x0000_0200
public const val FAN_DELETE_SELF: ULong = 0x0000_0400
public const val FAN_MOVE_SELF: ULong = 0x0000_0800
public const val FAN_OPEN_EXEC: ULong = 0x0000_1000
public const val FAN_Q_OVERFLOW: ULong = 0x0000_4000
public const val FAN_FS_ERROR: ULong = 0x0000_8000
public const val FAN_OPEN_PERM: ULong = 0x0001_0000
public const val FAN_ACCESS_PERM: ULong = 0x0002_0000
public const val FAN_OPEN_EXEC_PERM: ULong = 0x0004_0000
public const val FAN_EVENT_ON_CHILD: ULong = 0x0800_0000
public const val FAN_RENAME: ULong = 0x1000_0000
public const val FAN_ONDIR: ULong = 0x4000_0000
public val FAN_CLOSE: ULong = FAN_CLOSE_WRITE or FAN_CLOSE_NOWRITE
public val FAN_MOVE: ULong = FAN_MOVED_FROM or FAN_MOVED_TO
public const val FAN_CLOEXEC: CUInt = 0x0000_0001
public const val FAN_NONBLOCK: CUInt = 0x0000_0002
public const val FAN_CLASS_NOTIF: CUInt = 0x0000_0000
public const val FAN_CLASS_CONTENT: CUInt = 0x0000_0004
public const val FAN_CLASS_PRE_CONTENT: CUInt = 0x0000_0008
public const val FAN_UNLIMITED_QUEUE: CUInt = 0x0000_0010
public const val FAN_UNLIMITED_MARKS: CUInt = 0x0000_0020
public const val FAN_ENABLE_AUDIT: CUInt = 0x0000_0040
public const val FAN_REPORT_PIDFD: CUInt = 0x0000_0080
public const val FAN_REPORT_TID: CUInt = 0x0000_0100
public const val FAN_REPORT_FID: CUInt = 0x0000_0200
public const val FAN_REPORT_DIR_FID: CUInt = 0x0000_0400
public const val FAN_REPORT_NAME: CUInt = 0x0000_0800
public const val FAN_REPORT_TARGET_FID: CUInt = 0x0000_1000
public val FAN_REPORT_DFID_NAME: CUInt = FAN_REPORT_DIR_FID or FAN_REPORT_NAME
public const val FAN_MARK_ADD: CUInt = 0x0000_0001
public const val FAN_MARK_REMOVE: CUInt = 0x0000_0002
public const val FAN_MARK_DONT_FOLLOW: CUInt = 0x0000_0004
public const val FAN_MARK_ONLYDIR: CUInt = 0x0000_0008
public const val FAN_MARK_IGNORED_MASK: CUInt = 0x0000_0020
public const val FAN_MARK_IGNORED_SURV_MODIFY: CUInt = 0x0000_0040
public const val FAN_MARK_FLUSH: CUInt = 0x0000_0080
public const val FAN_MARK_EVICTABLE: CUInt = 0x0000_0200
public const val FAN_MARK_IGNORE: CUInt = 0x0000_0400
public const val FAN_MARK_INODE: CUInt = 0x0000_0000
public const val FAN_MARK_MOUNT: CUInt = 0x0000_0010
public const val FAN_MARK_FILESYSTEM: CUInt = 0x0000_0100
public val FAN_MARK_IGNORE_SURV: CUInt = FAN_MARK_IGNORE or FAN_MARK_IGNORED_SURV_MODIFY
public const val FANOTIFY_METADATA_VERSION: UByte = 3u
public const val FAN_EVENT_INFO_TYPE_FID: UByte = 1u
public const val FAN_EVENT_INFO_TYPE_DFID_NAME: UByte = 2u
public const val FAN_EVENT_INFO_TYPE_DFID: UByte = 3u
public const val FAN_EVENT_INFO_TYPE_PIDFD: UByte = 4u
public const val FAN_EVENT_INFO_TYPE_ERROR: UByte = 5u
public const val FAN_EVENT_INFO_TYPE_OLD_DFID_NAME: UByte = 10u
public const val FAN_EVENT_INFO_TYPE_NEW_DFID_NAME: UByte = 12u
public const val FAN_RESPONSE_INFO_NONE: UByte = 0u
public const val FAN_RESPONSE_INFO_AUDIT_RULE: UByte = 1u
...
public val XDP_SHARED_UMEM: U16 = 1 shl 0
public val XDP_COPY: U16 = 1 shl 1
public val XDP_ZEROCOPY: U16 = 1 shl 2
public val XDP_USE_NEED_WAKEUP: U16 = 1 shl 3
public val XDP_USE_SG: U16 = 1 shl 4
public val XDP_UMEM_UNALIGNED_CHUNK_FLAG: U32 = 1 shl 0
public val XDP_RING_NEED_WAKEUP: U32 = 1 shl 0
...
public val XDP_OPTIONS_ZEROCOPY: U32 = 1 shl 0
...
public val XDP_PKT_CONTD: U32 = 1 shl 0
public val XDP_UMEM_TX_SW_CSUM: U32 = 1 shl 1
public val XDP_UMEM_TX_METADATA_LEN: U32 = 1 shl 2
public val XDP_TXMD_FLAGS_TIMESTAMP: U32 = 1 shl 0
