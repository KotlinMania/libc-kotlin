// port-lint: source libc/src/unix/linux_like/linux/mod.rs
...
public val PIDFD_SIGNAL_THREAD_GROUP: CUInt = 1u shl 1
public val PIDFD_SIGNAL_PROCESS_GROUP: CUInt = 1u shl 2
public val PIDFD_INFO_PID: CUInt = 1u shl 0
public val PIDFD_INFO_CREDS: CUInt = 1u shl 1
...
public val PR_MDWE_NO_INHERIT: CUInt = 1u shl 1
...
public val CLOSE_RANGE_UNSHARE: CUInt = 1u shl 1
...
public val TP_STATUS_USER: U32 = 1u shl 0
public val TP_STATUS_COPY: U32 = 1u shl 1
public val TP_STATUS_LOSING: U32 = 1u shl 2
public val TP_STATUS_CSUMNOTREADY: U32 = 1u shl 3
public val TP_STATUS_VLAN_VALID: U32 = 1u shl 4
public val TP_STATUS_BLK_TMO: U32 = 1u shl 5
public val TP_STATUS_VLAN_TPID_VALID: U32 = 1u shl 6
public val TP_STATUS_CSUM_VALID: U32 = 1u shl 7
public const val TP_STATUS_AVAILABLE: U32 = 0u
public val TP_STATUS_SEND_REQUEST: U32 = 1u shl 0
public val TP_STATUS_SENDING: U32 = 1u shl 1
public val TP_STATUS_WRONG_FORMAT: U32 = 1u shl 2
public val TP_STATUS_TS_SOFTWARE: U32 = 1u shl 29
public val TP_STATUS_TS_SYS_HARDWARE: U32 = 1u shl 30
public val TP_STATUS_TS_RAW_HARDWARE: U32 = 1u shl 31
...
public val SOF_TXTIME_DEADLINE_MODE: UInt = 1u shl 0
public val SOF_TXTIME_REPORT_ERRORS: UInt = 1u shl 1
...
public const val FAN_ACCESS: ULong = 0x00000001uL
public const val FAN_MODIFY: ULong = 0x00000002uL
public const val FAN_ATTRIB: ULong = 0x00000004uL
public const val FAN_CLOSE_WRITE: ULong = 0x00000008uL
public const val FAN_CLOSE_NOWRITE: ULong = 0x00000010uL
public const val FAN_OPEN: ULong = 0x00000020uL
public const val FAN_MOVED_FROM: ULong = 0x00000040uL
public const val FAN_MOVED_TO: ULong = 0x00000080uL
public const val FAN_CREATE: ULong = 0x00000100uL
public const val FAN_DELETE: ULong = 0x00000200uL
public const val FAN_DELETE_SELF: ULong = 0x00000400uL
public const val FAN_MOVE_SELF: ULong = 0x00000800uL
public const val FAN_OPEN_EXEC: ULong = 0x00001000uL
public const val FAN_Q_OVERFLOW: ULong = 0x00004000uL
public const val FAN_FS_ERROR: ULong = 0x00008000uL
public const val FAN_OPEN_PERM: ULong = 0x00010000uL
public const val FAN_ACCESS_PERM: ULong = 0x00020000uL
public const val FAN_OPEN_EXEC_PERM: ULong = 0x00040000uL
public const val FAN_EVENT_ON_CHILD: ULong = 0x08000000uL
public const val FAN_RENAME: ULong = 0x10000000uL
public const val FAN_ONDIR: ULong = 0x40000000uL
public val FAN_CLOSE: ULong = FAN_CLOSE_WRITE or FAN_CLOSE_NOWRITE
public val FAN_MOVE: ULong = FAN_MOVED_FROM or FAN_MOVED_TO
public const val FAN_CLOEXEC: CUInt = 0x00000001u
public const val FAN_NONBLOCK: CUInt = 0x00000002u
public const val FAN_CLASS_NOTIF: CUInt = 0x00000000u
public const val FAN_CLASS_CONTENT: CUInt = 0x00000004u
public const val FAN_CLASS_PRE_CONTENT: CUInt = 0x00000008u
public const val FAN_UNLIMITED_QUEUE: CUInt = 0x00000010u
public const val FAN_UNLIMITED_MARKS: CUInt = 0x00000020u
public const val FAN_ENABLE_AUDIT: CUInt = 0x00000040u
public const val FAN_REPORT_PIDFD: CUInt = 0x00000080u
public const val FAN_REPORT_TID: CUInt = 0x00000100u
public const val FAN_REPORT_FID: CUInt = 0x00000200u
public const val FAN_REPORT_DIR_FID: CUInt = 0x00000400u
public const val FAN_REPORT_NAME: CUInt = 0x00000800u
public const val FAN_REPORT_TARGET_FID: CUInt = 0x00001000u
public val FAN_REPORT_DFID_NAME: CUInt = FAN_REPORT_DIR_FID or FAN_REPORT_NAME
public const val FAN_MARK_ADD: CUInt = 0x00000001u
public const val FAN_MARK_REMOVE: CUInt = 0x00000002u
public const val FAN_MARK_DONT_FOLLOW: CUInt = 0x00000004u
public const val FAN_MARK_ONLYDIR: CUInt = 0x00000008u
public const val FAN_MARK_IGNORED_MASK: CUInt = 0x00000020u
public const val FAN_MARK_IGNORED_SURV_MODIFY: CUInt = 0x00000040u
public const val FAN_MARK_FLUSH: CUInt = 0x00000080u
public const val FAN_MARK_EVICTABLE: CUInt = 0x00000200u
public const val FAN_MARK_IGNORE: CUInt = 0x00000400u
public const val FAN_MARK_INODE: CUInt = 0x00000000u
public const val FAN_MARK_MOUNT: CUInt = 0x00000010u
public const val FAN_MARK_FILESYSTEM: CUInt = 0x00000100u
...
public const val FUTEX_BITSET_MATCH_ANY: CInt = 0xffffffff.toInt()
...
public val XDP_OPTIONS_ZEROCOPY: U32 = 1u shl 0
...
public val XDP_PKT_CONTD: U32 = 1u shl 0
public val XDP_UMEM_TX_SW_CSUM: U32 = 1u shl 1
public val XDP_UMEM_TX_METADATA_LEN: U32 = 1u shl 2
public val XDP_TXMD_FLAGS_TIMESTAMP: U32 = 1u shl 0
public val XDP_TXMD_FLAGS_CHECKSUM: U32 = 1u shl 1
public val XDP_TX_METADATA: U32 = 1u shl 1
...
public const val EPIOCSPARAMS: Ioctl = 0x40088a01.toInt()
public const val EPIOCGPARAMS: Ioctl = 0x80088a02.toInt()
public const val SI_DETHREAD: CInt = -7
public const val TRAP_PERF: CInt = 6

// Inline helper functions (Rust `f!`/`safe_f!`); bodies provided per platform.
public fun sCTPPRINDEX(policy: CInt): CInt = -1

public fun sCTPPRPOLICY(policy: CInt): CInt = -1

public fun sCTPPRSETPOLICY(flags: CInt?, policy: CInt) { }
...
public fun readahead(fd: CInt, offset: Off64T, count: ULong): SsizeT = -1L
...
public fun timerfdCreate(clockid: ClockidT, flags: CInt): CInt = -1
...
public fun quotactl(cmd: CInt, special: String?, id: CInt, data: String?): CInt = -1
...
public fun syncFileRange(fd: CInt, offset: Off64T, nbytes: Off64T, flags: CUInt): CInt = -1

public fun posixMadvise(addr: COpaquePointer?, len: ULong, advice: CInt): CInt = -1

public fun remapFilePages(addr: COpaquePointer?, size: ULong, prot: CInt, pgoff: ULong, flags: CInt): CInt = -1

public fun mkstemps(template: String?, suffixlen: CInt): CInt = -1

public fun vhangup(): CInt = -1
...
public fun swapoff(path: String?): CInt = -1

public fun vmsplice(fd: CInt, iov: Iovec?, nrSegs: ULong, flags: CUInt): SsizeT = -1L

public fun personality(persona: CULong): CInt = -1
...
public fun inotifyRmWatch(fd: CInt, wd: CInt): CInt = -1
...
public fun fanotifyInit(flags: CUInt, eventFFlags: CUInt): CInt = -1
