// port-lint: source libc/src/unix/linux_like/linux/gnu/b64/riscv64/mod.rs
package io.github.kotlinmania.libc.unix.linuxlike.linux.gnu.b64.riscv64
...
public const val O_TMPFILE: CInt = 4259840
...
public const val SA_ONSTACK: CInt = 134217728
...
public const val SFD_CLOEXEC: CInt = 524288
...
public const val SA_NODEFER: CInt = 1073741824
public const val SA_RESETHAND: CInt = -2147483648
public const val SA_RESTART: CInt = 268435456
public const val SA_NOCLDSTOP: CInt = 1
public const val EPOLL_CLOEXEC: CInt = 524288
public const val EFD_CLOEXEC: CInt = 524288
...
public val COMPAT_HWCAP_ISA_I: CULong = 1uL shl ('I' - 'A')
public val COMPAT_HWCAP_ISA_M: CULong = 1uL shl ('M' - 'A')
public val COMPAT_HWCAP_ISA_A: CULong = 1uL shl ('A' - 'A')
public val COMPAT_HWCAP_ISA_F: CULong = 1uL shl ('F' - 'A')
public val COMPAT_HWCAP_ISA_D: CULong = 1uL shl ('D' - 'A')
public val COMPAT_HWCAP_ISA_C: CULong = 1uL shl ('C' - 'A')
public val COMPAT_HWCAP_ISA_V: CULong = 1uL shl ('V' - 'A')
