...
public const val RLIM_INFINITY: RlimT = 2147483647
...
public const val SCOPE_DELIMITER: UByte = 37u8
...
public const val IGNBRK: TcflagT = 1
public const val BRKINT: TcflagT = 2
public const val IGNPAR: TcflagT = 4
public const val PARMRK: TcflagT = 8
public const val INPCK: TcflagT = 16
public const val ISTRIP: TcflagT = 32
public const val INLCR: TcflagT = 64
public const val IGNCR: TcflagT = 128
public const val ICRNL: TcflagT = 256
public const val IXON: TcflagT = 512
public const val IXOFF: TcflagT = 1024
public const val IXANY: TcflagT = 2048
public const val IMAXBEL: TcflagT = 8192
public const val IUCLC: TcflagT = 16384
public const val OPOST: TcflagT = 1
public const val ONLCR: TcflagT = 2
public const val ONOEOT: TcflagT = 8
public const val OCRNL: TcflagT = 16
public const val ONOCR: TcflagT = 32
public const val ONLRET: TcflagT = 64
public const val NLDLY: TcflagT = 768
public const val NL0: TcflagT = 0
public const val NL1: TcflagT = 256
public const val TABDLY: TcflagT = 3076
public const val TAB0: TcflagT = 0
public const val TAB1: TcflagT = 1024
public const val TAB2: TcflagT = 2048
public const val TAB3: TcflagT = 4
public const val CRDLY: TcflagT = 12288
public const val CR0: TcflagT = 0
public const val CR1: TcflagT = 4096
public const val CR2: TcflagT = 8192
public const val CR3: TcflagT = 12288
public const val FFDLY: TcflagT = 16384
public const val FF0: TcflagT = 0
public const val FF1: TcflagT = 16384
public const val BSDLY: TcflagT = 32768
public const val BS0: TcflagT = 0
public const val BS1: TcflagT = 32768
public const val VTDLY: TcflagT = 65536
public const val VT0: TcflagT = 0
public const val VT1: TcflagT = 65536
public const val OLCUC: TcflagT = 131072
public const val OFILL: TcflagT = 262144
public const val OFDEL: TcflagT = 524288
public const val CIGNORE: TcflagT = 1
public const val CSIZE: TcflagT = 768
public const val CS5: TcflagT = 0
public const val CS6: TcflagT = 256
public const val CS7: TcflagT = 512
public const val CS8: TcflagT = 768
public const val CSTOPB: TcflagT = 1024
public const val CREAD: TcflagT = 2048
public const val PARENB: TcflagT = 4096
public const val PARODD: TcflagT = 8192
public const val HUPCL: TcflagT = 16384
public const val CLOCAL: TcflagT = 32768
public const val CRTSCTS: TcflagT = 65536
public const val CRTS_IFLOW: TcflagT = 65536
public const val CCTS_OFLOW: TcflagT = 65536
public const val CDTRCTS: TcflagT = 131072
public const val MDMBUF: TcflagT = 1048576
public const val CHWFLOW: TcflagT = 1245184
public const val ECHOKE: TcflagT = 1
public const val _ECHOE: TcflagT = 2
public const val ECHOE: TcflagT = 2
public const val _ECHOK: TcflagT = 4
public const val ECHOK: TcflagT = 4
public const val _ECHO: TcflagT = 8
public const val ECHO: TcflagT = 8
public const val _ECHONL: TcflagT = 16
public const val ECHONL: TcflagT = 16
public const val ECHOPRT: TcflagT = 32
public const val ECHOCTL: TcflagT = 64
public const val _ISIG: TcflagT = 128
public const val ISIG: TcflagT = 128
public const val _ICANON: TcflagT = 256
public const val ICANON: TcflagT = 256
public const val ALTWERASE: TcflagT = 512
public const val _IEXTEN: TcflagT = 1024
public const val IEXTEN: TcflagT = 1024
public const val EXTPROC: TcflagT = 2048
public const val _TOSTOP: TcflagT = 4194304
public const val TOSTOP: TcflagT = 4194304
public const val FLUSHO: TcflagT = 8388608
public const val NOKERNINFO: TcflagT = 33554432
public const val PENDIN: TcflagT = 536870912
public const val _NOFLSH: TcflagT = 2147483648
public const val NOFLSH: TcflagT = 2147483648
...
public const val B500000: SpeedT = 500000
public const val B576000: SpeedT = 576000
public const val B921600: SpeedT = 921600
public const val B1000000: SpeedT = 1000000
public const val B1152000: SpeedT = 1152000
public const val B1500000: SpeedT = 1500000
public const val B2000000: SpeedT = 2000000
public const val B2500000: SpeedT = 2500000
public const val B3000000: SpeedT = 3000000
public const val B3500000: SpeedT = 3500000
public const val B4000000: SpeedT = 4000000
...
public const val TTYDEF_IFLAG: TcflagT = 11042
public const val TTYDEF_LFLAG: TcflagT = 1483
public const val TTYDEF_CFLAG: TcflagT = 23040
public const val TTYDEF_SPEED: TcflagT = 9600
public const val CEOL: UByte = 0u8
public const val CERASE: UByte = 127u
public const val CMIN: UByte = 1u
public const val CQUIT: UByte = 28u
public const val CTIME: UByte = 0u
public const val CBRK: UByte = 0u8
...
public const val FPC_IE: UShort = 1u
public const val FPC_IM: UShort = 1u
public const val FPC_DE: UShort = 2u
public const val FPC_DM: UShort = 2u
public const val FPC_ZE: UShort = 4u
public const val FPC_ZM: UShort = 4u
public const val FPC_OE: UShort = 8u
public const val FPC_OM: UShort = 8u
public const val FPC_UE: UShort = 16u
public const val FPC_PE: UShort = 32u
public const val FPC_PC: UShort = 768u
public const val FPC_PC_24: UShort = 0u
public const val FPC_PC_53: UShort = 512u
public const val FPC_PC_64: UShort = 768u
public const val FPC_RC: UShort = 3072u
public const val FPC_RC_RN: UShort = 0u
public const val FPC_RC_RD: UShort = 1024u
public const val FPC_RC_RU: UShort = 2048u
public const val FPC_RC_CHOP: UShort = 3072u
public const val FPC_IC: UShort = 4096u
public const val FPC_IC_PROJ: UShort = 0u
public const val FPC_IC_AFF: UShort = 4096u
public const val FPS_IE: UShort = 1u
public const val FPS_DE: UShort = 2u
public const val FPS_ZE: UShort = 4u
public const val FPS_OE: UShort = 8u
public const val FPS_UE: UShort = 16u
public const val FPS_PE: UShort = 32u
public const val FPS_SF: UShort = 64u
public const val FPS_ES: UShort = 128u
public const val FPS_C0: UShort = 256u
public const val FPS_C1: UShort = 512u
public const val FPS_C2: UShort = 1024u
public const val FPS_TOS: UShort = 14336u
public const val FPS_TOS_SHIFT: UShort = 11u
public const val FPS_C3: UShort = 16384u
public const val FPS_BUSY: UShort = 32768u
...
public const val __S_IFMT: ModeT = 0o17_0000
public const val __S_IFDIR: ModeT = 0o4_0000
public const val __S_IFCHR: ModeT = 0o2_0000
public const val __S_IFBLK: ModeT = 0o6_0000
public const val __S_IFREG: ModeT = 0o10_0000
public const val __S_IFLNK: ModeT = 0o12_0000
public const val __S_IFSOCK: ModeT = 0o14_0000
public const val __S_IFIFO: ModeT = 0o1_0000
...
public const val S_INOCACHE: ModeT = 0o20_0000
public const val S_IUSEUNK: ModeT = 0o40_0000
public const val S_IUNKNOWN: ModeT = 0o700_0000
public const val S_IUNKSHIFT: ModeT = 12
public const val S_IPTRANS: ModeT = 0o1000_0000
public const val S_IATRANS: ModeT = 0o2000_0000
public const val S_IROOT: ModeT = 0o4000_0000
public const val S_ITRANS: ModeT = 0o7000_0000
public const val S_IMMAP0: ModeT = 0o10000_0000
...
public const val TANDEM: TcflagT = 1
public const val CBREAK: TcflagT = 2
public const val LCASE: TcflagT = 4
public const val CRMOD: TcflagT = 16
public const val RAW: TcflagT = 32
public const val ODDP: TcflagT = 64
public const val EVENP: TcflagT = 128
public const val ANYP: TcflagT = 192
public const val NLDELAY: TcflagT = 768
public const val NL2: TcflagT = 512
public const val NL3: TcflagT = 768
public const val TBDELAY: TcflagT = 3072
public const val XTABS: TcflagT = 3072
public const val CRDELAY: TcflagT = 12288
public const val VTDELAY: TcflagT = 16384
public const val BSDELAY: TcflagT = 32768
public const val ALLDELAY: TcflagT = 65280
public const val CRTBS: TcflagT = 65536
public const val PRTERA: TcflagT = 131072
public const val CRTERA: TcflagT = 262144
public const val TILDE: TcflagT = 524288
public const val LITOUT: TcflagT = 2097152
public const val NOHANG: TcflagT = 16777216
public const val L001000: TcflagT = 33554432
public const val CRTKIL: TcflagT = 67108864
public const val PASS8: TcflagT = 134217728
public const val CTLECH: TcflagT = 268435456
public const val DECCTQ: TcflagT = 1073741824
...
public const val UINT8_MAX: UByte = 255u
public const val UINT16_MAX: UShort = 65535u
...
public const val UINT_FAST16_MAX: UintFast16T = 4294967295
public const val UINT_FAST32_MAX: UintFast32T = 4294967295
...
public const val WINT_MIN: WintT = 0
public const val WINT_MAX: WintT = 4294967295
...
public const val TH_FIN: UByte = 1u
public const val TH_SYN: UByte = 2u
public const val TH_RST: UByte = 4u
public const val TH_PUSH: UByte = 8u
public const val TH_ACK: UByte = 16u
public const val TH_URG: UByte = 32u
public const val TCPOPT_EOL: UByte = 0u
public const val TCPOPT_NOP: UByte = 1u
public const val TCPOPT_MAXSEG: UByte = 2u
public const val TCPOLEN_MAXSEG: UByte = 4u
public const val TCPOPT_WINDOW: UByte = 3u
public const val TCPOLEN_WINDOW: UByte = 3u
public const val TCPOPT_SACK_PERMITTED: UByte = 4u
public const val TCPOLEN_SACK_PERMITTED: UByte = 2u
public const val TCPOPT_SACK: UByte = 5u
public const val TCPOPT_TIMESTAMP: UByte = 8u
public const val TCPOLEN_TIMESTAMP: UByte = 10u
public const val TCPOLEN_TSTAMP_APPA: UByte = 12u
...
public const val TCPI_OPT_TIMESTAMPS: UByte = 1u
public const val TCPI_OPT_SACK: UByte = 2u
public const val TCPI_OPT_WSCALE: UByte = 4u
public const val TCPI_OPT_ECN: UByte = 8u
public const val TCPI_OPT_ECN_SEEN: UByte = 16u
public const val TCPI_OPT_SYN_DATA: UByte = 32u
...
public const val PTHREAD_PROCESS_PRIVATE: PthreadProcessShared = 0
public const val PTHREAD_PROCESS_SHARED: PthreadProcessShared = 1
public const val PTHREAD_EXPLICIT_SCHED: PthreadInheritsched = 0
public const val PTHREAD_INHERIT_SCHED: PthreadInheritsched = 1
public const val PTHREAD_SCOPE_SYSTEM: PthreadContentionscope = 0
public const val PTHREAD_SCOPE_PROCESS: PthreadContentionscope = 1
public const val PTHREAD_CREATE_JOINABLE: PthreadDetachstate = 0
public const val PTHREAD_CREATE_DETACHED: PthreadDetachstate = 1
public const val PTHREAD_PRIO_NONE: PthreadMutexProtocol = 0
public const val PTHREAD_PRIO_INHERIT: PthreadMutexProtocol = 1
public const val PTHREAD_PRIO_PROTECT: PthreadMutexProtocol = 2
public const val PTHREAD_MUTEX_TIMED: PthreadMutexType = 0
public const val PTHREAD_MUTEX_ERRORCHECK: PthreadMutexType = 1
public const val PTHREAD_MUTEX_RECURSIVE: PthreadMutexType = 2
public const val PTHREAD_MUTEX_STALLED: PthreadMutexRobustness = 0
public const val PTHREAD_MUTEX_ROBUST: PthreadMutexRobustness = 256
...
public const val RLIMIT_MEMLOCK: RlimitResourceT = 6
public const val RLIMIT_NPROC: RlimitResourceT = 7
public const val RLIMIT_OFILE: RlimitResourceT = 8
public const val RLIMIT_NOFILE: RlimitResourceT = 8
public const val RLIMIT_SBSIZE: RlimitResourceT = 9
public const val RLIMIT_AS: RlimitResourceT = 10
public const val RLIMIT_VMEM: RlimitResourceT = 10
public const val RLIMIT_NLIMITS: RlimitResourceT = 11
public const val RLIM_NLIMITS: RlimitResourceT = 11
public const val RUSAGE_SELF: RusageWho = 0
public const val RUSAGE_CHILDREN: RusageWho = -1
public const val PRIO_PROCESS: PriorityWhich = 0
public const val PRIO_PGRP: PriorityWhich = 1
public const val PRIO_USER: PriorityWhich = 2
...
public const val IPPORT_ECHO: InPortT = 7
public const val IPPORT_DISCARD: InPortT = 9
public const val IPPORT_SYSTAT: InPortT = 11
public const val IPPORT_DAYTIME: InPortT = 13
public const val IPPORT_NETSTAT: InPortT = 15
public const val IPPORT_FTP: InPortT = 21
public const val IPPORT_TELNET: InPortT = 23
public const val IPPORT_SMTP: InPortT = 25
public const val IPPORT_TIMESERVER: InPortT = 37
public const val IPPORT_NAMESERVER: InPortT = 42
public const val IPPORT_WHOIS: InPortT = 43
public const val IPPORT_MTP: InPortT = 57
public const val IPPORT_TFTP: InPortT = 69
public const val IPPORT_RJE: InPortT = 77
public const val IPPORT_FINGER: InPortT = 79
public const val IPPORT_TTYLINK: InPortT = 87
public const val IPPORT_SUPDUP: InPortT = 95
public const val IPPORT_EXECSERVER: InPortT = 512
public const val IPPORT_LOGINSERVER: InPortT = 513
public const val IPPORT_CMDSERVER: InPortT = 514
public const val IPPORT_EFSSERVER: InPortT = 520
public const val IPPORT_BIFFUDP: InPortT = 512
public const val IPPORT_WHOSERVER: InPortT = 513
public const val IPPORT_ROUTESERVER: InPortT = 520
public const val IPPORT_USERRESERVED: InPortT = 5000
...
public const val DT_WHT: CUChar = 14u
...
public const val IOC_VOID: IoctlDir = 0
public const val IOC_OUT: IoctlDir = 1
public const val IOC_IN: IoctlDir = 2
public const val IOC_INOUT: IoctlDir = 3
public const val IOC_8: IoctlDatum = 0
public const val IOC_16: IoctlDatum = 1
public const val IOC_32: IoctlDatum = 2
public const val IOC_64: IoctlDatum = 3
...
public const val TCP_CA_Open: TcpCaState = 0
public const val TCP_CA_Disorder: TcpCaState = 1
public const val TCP_CA_CWR: TcpCaState = 2
public const val TCP_CA_Recovery: TcpCaState = 3
public const val TCP_CA_Loss: TcpCaState = 4
