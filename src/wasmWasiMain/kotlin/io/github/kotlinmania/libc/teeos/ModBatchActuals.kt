...
public actual fun pthreadAttrSettee(attr: PthreadAttrT?, ca: CInt, taskId: CInt, shadow: CInt): CInt =
    throw UnsupportedOperationException("pthreadAttrSettee not available on WASI — no C library access")
...
public actual fun mbrtowc(wc: WcharT?, src: String?, n: ULong, st: MbstateT?): ULong =
    throw UnsupportedOperationException("mbrtowc not available on WASI — no C library access")

public actual fun wcrtomb(s: String?, wc: WcharT, st: MbstateT?): ULong =
    throw UnsupportedOperationException("wcrtomb not available on WASI — no C library access")
...
public actual fun wcschr(s: WcharT?, c: WcharT): WcharT? =
    throw UnsupportedOperationException("wcschr not available on WASI — no C library access")
...
public actual fun isascii(c: CInt): CInt =
    throw UnsupportedOperationException("isascii not available on WASI — no C library access")
...
public actual fun iswctype(wc: WintT, ttype: WctypeT): CInt =
    throw UnsupportedOperationException("iswctype not available on WASI — no C library access")

public actual fun iswdigit(wc: WintT): CInt =
    throw UnsupportedOperationException("iswdigit not available on WASI — no C library access")

public actual fun iswlower(wc: WintT): CInt =
    throw UnsupportedOperationException("iswlower not available on WASI — no C library access")

public actual fun iswspace(wc: WintT): CInt =
    throw UnsupportedOperationException("iswspace not available on WASI — no C library access")

public actual fun iswupper(wc: WintT): CInt =
    throw UnsupportedOperationException("iswupper not available on WASI — no C library access")
...
public actual fun ecvt(x: CDouble, n: CInt, dp: CInt?, sign: CInt?): String? =
    throw UnsupportedOperationException("ecvt not available on WASI — no C library access")
