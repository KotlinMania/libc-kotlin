...
public actual fun psetBindLwp(pset: PsetidT, id: IdT, pid: PidT, opset: PsetidT?): CInt =
    throw UnsupportedOperationException("psetBindLwp not available on WASI — no C library access")

public actual fun psetGetloadavg(pset: PsetidT, load: CDouble?, num: CInt): CInt =
    throw UnsupportedOperationException("psetGetloadavg not available on WASI — no C library access")
...
public actual fun getpagesizes2(pagesize: ULong?, nelem: CInt): CInt =
    throw UnsupportedOperationException("getpagesizes2 not available on WASI — no C library access")
