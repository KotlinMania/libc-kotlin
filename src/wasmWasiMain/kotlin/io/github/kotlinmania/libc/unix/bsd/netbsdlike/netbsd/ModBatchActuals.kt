...
public actual fun pROTMPROTECT(x: CInt): CInt =
    throw UnsupportedOperationException("pROTMPROTECT not available on WASI — no C library access")

public actual fun pROTMPROTECTEXTRACT(x: CInt): CInt =
    throw UnsupportedOperationException("pROTMPROTECTEXTRACT not available on WASI — no C library access")
...
public actual fun reallocarr(ptr: COpaquePointer?, number: ULong, size: ULong): CInt =
    throw UnsupportedOperationException("reallocarr not available on WASI — no C library access")
...
public actual fun pthreadGetattrNp(native: PthreadT, attr: PthreadAttrT?): CInt =
    throw UnsupportedOperationException("pthreadGetattrNp not available on WASI — no C library access")
...
public actual fun cpusetCreate(): CpusetT? =
    throw UnsupportedOperationException("cpusetCreate not available on WASI — no C library access")

public actual fun cpusetDestroy(set: CpusetT?) {
    throw UnsupportedOperationException("cpusetDestroy not available on WASI — no C library access")
}

public actual fun cpusetClr(cpu: CpuidT, set: CpusetT?): CInt =
    throw UnsupportedOperationException("cpusetClr not available on WASI — no C library access")

public actual fun cpusetSet(cpu: CpuidT, set: CpusetT?): CInt =
    throw UnsupportedOperationException("cpusetSet not available on WASI — no C library access")

public actual fun cpusetIsset(cpu: CpuidT, set: CpusetT?): CInt =
    throw UnsupportedOperationException("cpusetIsset not available on WASI — no C library access")

public actual fun cpusetSize(set: CpusetT?): ULong =
    throw UnsupportedOperationException("cpusetSize not available on WASI — no C library access")

public actual fun cpusetZero(set: CpusetT?) {
    throw UnsupportedOperationException("cpusetZero not available on WASI — no C library access")
}
...
public actual fun kqueue1(flags: CInt): CInt =
    throw UnsupportedOperationException("kqueue1 not available on WASI — no C library access")

public actual fun lwpSelf(): LwpidT =
    throw UnsupportedOperationException("lwpSelf not available on WASI — no C library access")
...
public actual fun dlauxinfo(): COpaquePointer? =
    throw UnsupportedOperationException("dlauxinfo not available on WASI — no C library access")
...
public actual fun pollts(fds: Pollfd?, nfds: NfdsT, ts: Timespec?, sigmask: SigsetT?): CInt =
    throw UnsupportedOperationException("pollts not available on WASI — no C library access")
...
public actual fun lwpPark(clock: ClockidT, flags: CInt, ts: Timespec?, unpark: LwpidT, hint: COpaquePointer?, unparkhint: COpaquePointer?): CInt =
    throw UnsupportedOperationException("lwpPark not available on WASI — no C library access")

public actual fun lwpUnpark(lwp: LwpidT, hint: COpaquePointer?): CInt =
    throw UnsupportedOperationException("lwpUnpark not available on WASI — no C library access")

public actual fun lwpUnparkAll(targets: LwpidT?, ntargets: ULong, hint: COpaquePointer?): CInt =
    throw UnsupportedOperationException("lwpUnparkAll not available on WASI — no C library access")
...
public actual fun getvfsstat(buf: Statvfs?, bufsize: ULong, flags: CInt): CInt =
    throw UnsupportedOperationException("getvfsstat not available on WASI — no C library access")
...
public actual fun emalloc(n: ULong): COpaquePointer? =
    throw UnsupportedOperationException("emalloc not available on WASI — no C library access")

public actual fun ecalloc(n: ULong, c: ULong): COpaquePointer? =
    throw UnsupportedOperationException("ecalloc not available on WASI — no C library access")

public actual fun erealloc(p: COpaquePointer?, n: ULong): COpaquePointer? =
    throw UnsupportedOperationException("erealloc not available on WASI — no C library access")

public actual fun ereallocarr(p: COpaquePointer?, n: ULong, s: ULong) {
    throw UnsupportedOperationException("ereallocarr not available on WASI — no C library access")
}

public actual fun estrdup(s: String?): String? =
    throw UnsupportedOperationException("estrdup not available on WASI — no C library access")

public actual fun estrndup(s: String?, len: ULong): String? =
    throw UnsupportedOperationException("estrndup not available on WASI — no C library access")

public actual fun estrlcpy(dst: String?, src: String?, len: ULong): ULong =
    throw UnsupportedOperationException("estrlcpy not available on WASI — no C library access")

public actual fun estrlcat(dst: String?, src: String?, len: ULong): ULong =
    throw UnsupportedOperationException("estrlcat not available on WASI — no C library access")

public actual fun easprintf(string: COpaquePointer?, fmt: String?, vararg args: Any?): CInt =
    throw UnsupportedOperationException("easprintf not available on WASI — no C library access")

public actual fun evasprintf(string: COpaquePointer?, fmt: String?, vararg args: Any?): CInt =
    throw UnsupportedOperationException("evasprintf not available on WASI — no C library access")

public actual fun securePath(path: String?): CInt =
    throw UnsupportedOperationException("securePath not available on WASI — no C library access")

public actual fun snprintb(buf: String?, buflen: ULong, fmt: String?, `val`: ULong): CInt =
    throw UnsupportedOperationException("snprintb not available on WASI — no C library access")

public actual fun snprintbM(buf: String?, buflen: ULong, fmt: String?, `val`: ULong, max: ULong): CInt =
    throw UnsupportedOperationException("snprintbM not available on WASI — no C library access")

public actual fun getbootfile(): String? =
    throw UnsupportedOperationException("getbootfile not available on WASI — no C library access")

public actual fun getbyteorder(): CInt =
    throw UnsupportedOperationException("getbyteorder not available on WASI — no C library access")

public actual fun getdiskrawname(buf: String?, buflen: ULong, name: String?): String? =
    throw UnsupportedOperationException("getdiskrawname not available on WASI — no C library access")

public actual fun getdiskcookedname(buf: String?, buflen: ULong, name: String?): String? =
    throw UnsupportedOperationException("getdiskcookedname not available on WASI — no C library access")

public actual fun getfsspecname(buf: String?, buflen: ULong, spec: String?): String? =
    throw UnsupportedOperationException("getfsspecname not available on WASI — no C library access")

public actual fun strpct(buf: String?, bufsiz: ULong, numerator: UintmaxT, denominator: UintmaxT, precision: ULong): String? =
    throw UnsupportedOperationException("strpct not available on WASI — no C library access")

public actual fun strspct(buf: String?, bufsiz: ULong, numerator: IntmaxT, denominator: IntmaxT, precision: ULong): String? =
    throw UnsupportedOperationException("strspct not available on WASI — no C library access")

public actual fun login(ut: Utmp?) {
    throw UnsupportedOperationException("login not available on WASI — no C library access")
}

public actual fun loginx(ut: Utmpx?) {
    throw UnsupportedOperationException("loginx not available on WASI — no C library access")
}

public actual fun logout(line: String?) {
    throw UnsupportedOperationException("logout not available on WASI — no C library access")
}

public actual fun logoutx(line: String?, status: CInt, tpe: CInt) {
    throw UnsupportedOperationException("logoutx not available on WASI — no C library access")
}

public actual fun logwtmp(line: String?, name: String?, host: String?) {
    throw UnsupportedOperationException("logwtmp not available on WASI — no C library access")
}

public actual fun logwtmpx(line: String?, name: String?, host: String?, status: CInt, tpe: CInt) {
    throw UnsupportedOperationException("logwtmpx not available on WASI — no C library access")
}
...
public actual fun stringToFlags(stringP: COpaquePointer?, setp: CULong?, clrp: CULong?): CInt =
    throw UnsupportedOperationException("stringToFlags not available on WASI — no C library access")

public actual fun flagsToString(flags: CULong, def: String?): CInt =
    throw UnsupportedOperationException("flagsToString not available on WASI — no C library access")
...
public actual fun backtraceSymbolsFmt(addrlist: COpaquePointer?, len: ULong, fmt: String?): COpaquePointer? =
    throw UnsupportedOperationException("backtraceSymbolsFmt not available on WASI — no C library access")

public actual fun backtraceSymbolsFdFmt(addrlist: COpaquePointer?, len: ULong, fd: CInt, fmt: String?): CInt =
    throw UnsupportedOperationException("backtraceSymbolsFdFmt not available on WASI — no C library access")
