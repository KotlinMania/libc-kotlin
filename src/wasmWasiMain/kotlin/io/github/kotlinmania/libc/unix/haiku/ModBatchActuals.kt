...
public actual fun getusershell(): String? =
    throw UnsupportedOperationException("getusershell not available on WASI — no C library access")
...
public actual fun errnop(): CInt? =
    throw UnsupportedOperationException("errnop not available on WASI — no C library access")
...
public actual fun sgetspent(line: String?): Spwd? =
    throw UnsupportedOperationException("sgetspent not available on WASI — no C library access")
...
public actual fun fgetspent(file: FILE?): Spwd? =
    throw UnsupportedOperationException("fgetspent not available on WASI — no C library access")
...
public actual fun valloc(numBytes: ULong): COpaquePointer? =
    throw UnsupportedOperationException("valloc not available on WASI — no C library access")
