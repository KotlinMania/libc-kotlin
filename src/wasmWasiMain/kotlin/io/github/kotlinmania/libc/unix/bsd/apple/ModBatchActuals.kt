...
public actual fun getdate(datestr: String?): Tm? =
    throw UnsupportedOperationException("getdate not available on WASI — no C library access")
...
public actual fun machAbsoluteTime(): ULong =
    throw UnsupportedOperationException("machAbsoluteTime not available on WASI — no C library access")

public actual fun machTimebaseInfo(info: MachTimebaseInfo?): CInt =
    throw UnsupportedOperationException("machTimebaseInfo not available on WASI — no C library access")

public actual fun pthreadCondTimedwaitRelativeNp(cond: PthreadCondT, lock: PthreadMutexT, timeout: Timespec?): CInt =
    throw UnsupportedOperationException("pthreadCondTimedwaitRelativeNp not available on WASI — no C library access")

public actual fun pthreadAttrGetscope(attr: PthreadAttrT, contentionscope: CInt?): CInt =
    throw UnsupportedOperationException("pthreadAttrGetscope not available on WASI — no C library access")

public actual fun pthreadAttrGetstackaddr(attr: PthreadAttrT, stackaddr: COpaquePointer?): CInt =
    throw UnsupportedOperationException("pthreadAttrGetstackaddr not available on WASI — no C library access")
...
public actual fun pthreadAttrSetscope(attr: PthreadAttrT, contentionscope: CInt): CInt =
    throw UnsupportedOperationException("pthreadAttrSetscope not available on WASI — no C library access")

public actual fun pthreadAttrSetstackaddr(attr: PthreadAttrT, stackaddr: COpaquePointer?): CInt =
    throw UnsupportedOperationException("pthreadAttrSetstackaddr not available on WASI — no C library access")
...
public actual fun pthreadGetStackaddrNp(thread: PthreadT): COpaquePointer? =
    throw UnsupportedOperationException("pthreadGetStackaddrNp not available on WASI — no C library access")

public actual fun pthreadGetStacksizeNp(thread: PthreadT): ULong =
    throw UnsupportedOperationException("pthreadGetStacksizeNp not available on WASI — no C library access")
...
public actual fun pthreadThreadidNp(thread: PthreadT, threadId: ULong?): CInt =
    throw UnsupportedOperationException("pthreadThreadidNp not available on WASI — no C library access")

public actual fun pthreadJitWriteProtectNp(enabled: CInt) {
    throw UnsupportedOperationException("pthreadJitWriteProtectNp not available on WASI — no C library access")
}

public actual fun pthreadJitWriteProtectSupportedNp(): CInt =
    throw UnsupportedOperationException("pthreadJitWriteProtectSupportedNp not available on WASI — no C library access")

public actual fun pthreadJitWriteWithCallbackNp(callback: PthreadJitWriteCallbackT, ctx: COpaquePointer?): CInt =
    throw UnsupportedOperationException("pthreadJitWriteWithCallbackNp not available on WASI — no C library access")

public actual fun pthreadJitWriteFreezeCallbacksNp() {
    throw UnsupportedOperationException("pthreadJitWriteFreezeCallbacksNp not available on WASI — no C library access")
}

public actual fun pthreadCpuNumberNp(cpuNumberOut: ULong?): CInt =
    throw UnsupportedOperationException("pthreadCpuNumberNp not available on WASI — no C library access")

public actual fun osSyncWaitOnAddress(addr: COpaquePointer?, value: ULong, size: ULong, flags: OsSyncWaitOnAddressFlagsT): CInt =
    throw UnsupportedOperationException("osSyncWaitOnAddress not available on WASI — no C library access")
...
public actual fun osSyncWaitOnAddressWithDeadline(addr: COpaquePointer?, value: ULong, size: ULong, flags: OsSyncWaitOnAddressFlagsT, clockid: OsClockidT, deadline: ULong): CInt =
    throw UnsupportedOperationException("osSyncWaitOnAddressWithDeadline not available on WASI — no C library access")
...
public actual fun osSyncWaitOnAddressWithTimeout(addr: COpaquePointer?, value: ULong, size: ULong, flags: OsSyncWaitOnAddressFlagsT, clockid: OsClockidT, timeoutNs: ULong): CInt =
    throw UnsupportedOperationException("osSyncWaitOnAddressWithTimeout not available on WASI — no C library access")

public actual fun osSyncWakeByAddressAny(addr: COpaquePointer?, size: ULong, flags: OsSyncWakeByAddressFlagsT): CInt =
    throw UnsupportedOperationException("osSyncWakeByAddressAny not available on WASI — no C library access")

public actual fun osSyncWakeByAddressAll(addr: COpaquePointer?, size: ULong, flags: OsSyncWakeByAddressFlagsT): CInt =
    throw UnsupportedOperationException("osSyncWakeByAddressAll not available on WASI — no C library access")

public actual fun osUnfairLockLock(lock: OsUnfairLockT) {
    throw UnsupportedOperationException("osUnfairLockLock not available on WASI — no C library access")
}

public actual fun osUnfairLockTrylock(lock: OsUnfairLockT): Boolean =
    throw UnsupportedOperationException("osUnfairLockTrylock not available on WASI — no C library access")

public actual fun osUnfairLockUnlock(lock: OsUnfairLockT) {
    throw UnsupportedOperationException("osUnfairLockUnlock not available on WASI — no C library access")
}

public actual fun osUnfairLockAssertOwner(lock: OsUnfairLockT) {
    throw UnsupportedOperationException("osUnfairLockAssertOwner not available on WASI — no C library access")
}

public actual fun osUnfairLockAssertNotOwner(lock: OsUnfairLockT) {
    throw UnsupportedOperationException("osUnfairLockAssertNotOwner not available on WASI — no C library access")
}

public actual fun osLogTypeEnabled(oslog: OsLogT, tpe: OsLogTypeT): Boolean =
    throw UnsupportedOperationException("osLogTypeEnabled not available on WASI — no C library access")

public actual fun osSignpostEnabled(log: OsLogT): Boolean =
    throw UnsupportedOperationException("osSignpostEnabled not available on WASI — no C library access")
...
public actual fun threadPolicySet(thread: ThreadT, flavor: ThreadPolicyFlavorT, policyInfo: ThreadPolicyT, count: MachMsgTypeNumberT): KernReturnT =
    throw UnsupportedOperationException("threadPolicySet not available on WASI — no C library access")
...
public actual fun threadPolicyGet(thread: ThreadT, flavor: ThreadPolicyFlavorT, policyInfo: ThreadPolicyT, count: MachMsgTypeNumberT?, getDefault: BooleanT?): KernReturnT =
    throw UnsupportedOperationException("threadPolicyGet not available on WASI — no C library access")
...
public actual fun threadInfo(targetAct: ThreadInspectT, flavor: ThreadFlavorT, threadInfoOut: ThreadInfoT, threadInfoOutCnt: MachMsgTypeNumberT?): KernReturnT =
    throw UnsupportedOperationException("threadInfo not available on WASI — no C library access")
...
public actual fun backtraceFromFp(startfp: COpaquePointer?, array: COpaquePointer?, size: CInt): CInt =
    throw UnsupportedOperationException("backtraceFromFp not available on WASI — no C library access")

public actual fun backtraceImageOffsets(array: COpaquePointer?, imageOffsets: ImageOffset?, size: CInt) {
    throw UnsupportedOperationException("backtraceImageOffsets not available on WASI — no C library access")
}

public actual fun backtraceAsync(array: COpaquePointer?, length: ULong, taskId: UInt?): ULong =
    throw UnsupportedOperationException("backtraceAsync not available on WASI — no C library access")
...
public actual fun kevent64(kq: CInt, changelist: Kevent64S?, nchanges: CInt, eventlist: Kevent64S?, nevents: CInt, flags: CUInt, timeout: Timespec?): CInt =
    throw UnsupportedOperationException("kevent64 not available on WASI — no C library access")
...
public actual fun fmount(src: String?, fd: CInt, flags: CInt, data: COpaquePointer?): CInt =
    throw UnsupportedOperationException("fmount not available on WASI — no C library access")
...
public actual fun renamexNp(from: String?, to: String?, flags: CUInt): CInt =
    throw UnsupportedOperationException("renamexNp not available on WASI — no C library access")

public actual fun renameatxNp(fromfd: CInt, from: String?, tofd: CInt, to: String?, flags: CUInt): CInt =
    throw UnsupportedOperationException("renameatxNp not available on WASI — no C library access")
...
public actual fun dyldGetImageHeader(imageIndex: UInt): MachHeader? =
    throw UnsupportedOperationException("dyldGetImageHeader not available on WASI — no C library access")

public actual fun dyldGetImageVmaddrSlide(imageIndex: UInt): IntptrT =
    throw UnsupportedOperationException("dyldGetImageVmaddrSlide not available on WASI — no C library access")

public actual fun dyldGetImageName(imageIndex: UInt): String? =
    throw UnsupportedOperationException("dyldGetImageName not available on WASI — no C library access")
...
public actual fun posixSpawnattrSetarchprefNp(attr: PosixSpawnattrT, count: ULong, pref: CpuTypeT?, subpref: CpuSubtypeT?, ocount: ULong?): CInt =
    throw UnsupportedOperationException("posixSpawnattrSetarchprefNp not available on WASI — no C library access")
...
public actual fun posixSpawnattrGetarchprefNp(attr: PosixSpawnattrT, count: ULong, pref: CpuTypeT?, subpref: CpuSubtypeT?, ocount: ULong?): CInt =
    throw UnsupportedOperationException("posixSpawnattrGetarchprefNp not available on WASI — no C library access")

public actual fun posixSpawnattrGetbinprefNp(attr: PosixSpawnattrT, count: ULong, pref: CpuTypeT?, ocount: ULong?): CInt =
    throw UnsupportedOperationException("posixSpawnattrGetbinprefNp not available on WASI — no C library access")

public actual fun posixSpawnattrSetbinprefNp(attr: PosixSpawnattrT, count: ULong, pref: CpuTypeT?, ocount: ULong?): CInt =
    throw UnsupportedOperationException("posixSpawnattrSetbinprefNp not available on WASI — no C library access")
...
public actual fun connectx(socket: CInt, endpoints: SaEndpointsT?, associd: SaeAssocidT, flags: CUInt, iov: Iovec?, iovcnt: CUInt, len: ULong?, connid: SaeConnidT?): CInt =
    throw UnsupportedOperationException("connectx not available on WASI — no C library access")

public actual fun disconnectx(socket: CInt, associd: SaeAssocidT, connid: SaeConnidT): CInt =
    throw UnsupportedOperationException("disconnectx not available on WASI — no C library access")
...
public actual fun clonefile(src: String?, dst: String?, flags: UInt): CInt =
    throw UnsupportedOperationException("clonefile not available on WASI — no C library access")

public actual fun clonefileat(srcDirfd: CInt, src: String?, dstDirfd: CInt, dst: String?, flags: UInt): CInt =
    throw UnsupportedOperationException("clonefileat not available on WASI — no C library access")

public actual fun fclonefileat(srcfd: CInt, dstDirfd: CInt, dst: String?, flags: UInt): CInt =
    throw UnsupportedOperationException("fclonefileat not available on WASI — no C library access")

public actual fun copyfile(from: String?, to: String?, state: CopyfileStateT, flags: CopyfileFlagsT): CInt =
    throw UnsupportedOperationException("copyfile not available on WASI — no C library access")

public actual fun fcopyfile(from: CInt, to: CInt, state: CopyfileStateT, flags: CopyfileFlagsT): CInt =
    throw UnsupportedOperationException("fcopyfile not available on WASI — no C library access")

public actual fun copyfileStateFree(s: CopyfileStateT): CInt =
    throw UnsupportedOperationException("copyfileStateFree not available on WASI — no C library access")

public actual fun copyfileStateGet(s: CopyfileStateT, flags: UInt, dst: COpaquePointer?): CInt =
    throw UnsupportedOperationException("copyfileStateGet not available on WASI — no C library access")

public actual fun copyfileStateSet(s: CopyfileStateT, flags: UInt, src: COpaquePointer?): CInt =
    throw UnsupportedOperationException("copyfileStateSet not available on WASI — no C library access")

public actual fun machErrorString(errorValue: MachErrorT): String? =
    throw UnsupportedOperationException("machErrorString not available on WASI — no C library access")
...
public actual fun memsetPattern4(b: COpaquePointer?, pattern4: COpaquePointer?, len: ULong) {
    throw UnsupportedOperationException("memsetPattern4 not available on WASI — no C library access")
}

public actual fun memsetPattern8(b: COpaquePointer?, pattern8: COpaquePointer?, len: ULong) {
    throw UnsupportedOperationException("memsetPattern8 not available on WASI — no C library access")
}

public actual fun memsetPattern16(b: COpaquePointer?, pattern16: COpaquePointer?, len: ULong) {
    throw UnsupportedOperationException("memsetPattern16 not available on WASI — no C library access")
}
...
public actual fun mallocPrintf(format: String?, vararg args: Any?) {
    throw UnsupportedOperationException("mallocPrintf not available on WASI — no C library access")
}

public actual fun mallocZoneCheck(zone: MallocZoneT): BooleanT =
    throw UnsupportedOperationException("mallocZoneCheck not available on WASI — no C library access")

public actual fun mallocZonePrint(zone: MallocZoneT, verbose: BooleanT) {
    throw UnsupportedOperationException("mallocZonePrint not available on WASI — no C library access")
}

public actual fun mallocZoneStatistics(zone: MallocZoneT, stats: MallocStatisticsT?) {
    throw UnsupportedOperationException("mallocZoneStatistics not available on WASI — no C library access")
}

public actual fun mallocZoneLog(zone: MallocZoneT, address: COpaquePointer?) {
    throw UnsupportedOperationException("mallocZoneLog not available on WASI — no C library access")
}

public actual fun mallocZonePrintPtrInfo(ptr: COpaquePointer?) {
    throw UnsupportedOperationException("mallocZonePrintPtrInfo not available on WASI — no C library access")
}

public actual fun mallocDefaultZone(): MallocZoneT =
    throw UnsupportedOperationException("mallocDefaultZone not available on WASI — no C library access")

public actual fun mallocZoneFromPtr(ptr: COpaquePointer?): MallocZoneT =
    throw UnsupportedOperationException("mallocZoneFromPtr not available on WASI — no C library access")

public actual fun mallocZoneMalloc(zone: MallocZoneT, size: ULong): COpaquePointer? =
    throw UnsupportedOperationException("mallocZoneMalloc not available on WASI — no C library access")

public actual fun mallocZoneValloc(zone: MallocZoneT, size: ULong): COpaquePointer? =
    throw UnsupportedOperationException("mallocZoneValloc not available on WASI — no C library access")

public actual fun mallocZoneCalloc(zone: MallocZoneT, numItems: ULong, size: ULong): COpaquePointer? =
    throw UnsupportedOperationException("mallocZoneCalloc not available on WASI — no C library access")

public actual fun mallocZoneRealloc(zone: MallocZoneT, ptr: COpaquePointer?, size: ULong): COpaquePointer? =
    throw UnsupportedOperationException("mallocZoneRealloc not available on WASI — no C library access")

public actual fun mallocZoneFree(zone: MallocZoneT, ptr: COpaquePointer?) {
    throw UnsupportedOperationException("mallocZoneFree not available on WASI — no C library access")
}

public actual fun procListpids(t: UInt, typeinfo: UInt, buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procListpids not available on WASI — no C library access")

public actual fun procListallpids(buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procListallpids not available on WASI — no C library access")

public actual fun procListpgrppids(pgrpid: PidT, buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procListpgrppids not available on WASI — no C library access")

public actual fun procListchildpids(ppid: PidT, buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procListchildpids not available on WASI — no C library access")

public actual fun procPidinfo(pid: CInt, flavor: CInt, arg: ULong, buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procPidinfo not available on WASI — no C library access")

public actual fun procPidfdinfo(pid: CInt, fd: CInt, flavor: CInt, buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procPidfdinfo not available on WASI — no C library access")

public actual fun procPidfileportinfo(pid: CInt, fileport: UInt, flavor: CInt, buffer: COpaquePointer?, buffersize: CInt): CInt =
    throw UnsupportedOperationException("procPidfileportinfo not available on WASI — no C library access")

public actual fun procPidpath(pid: CInt, buffer: COpaquePointer?, buffersize: UInt): CInt =
    throw UnsupportedOperationException("procPidpath not available on WASI — no C library access")

public actual fun procName(pid: CInt, buffer: COpaquePointer?, buffersize: UInt): CInt =
    throw UnsupportedOperationException("procName not available on WASI — no C library access")

public actual fun procRegionfilename(pid: CInt, address: ULong, buffer: COpaquePointer?, buffersize: UInt): CInt =
    throw UnsupportedOperationException("procRegionfilename not available on WASI — no C library access")

public actual fun procKmsgbuf(buffer: COpaquePointer?, buffersize: UInt): CInt =
    throw UnsupportedOperationException("procKmsgbuf not available on WASI — no C library access")

public actual fun procLibversion(major: CInt?, minor: CInt?): CInt =
    throw UnsupportedOperationException("procLibversion not available on WASI — no C library access")

public actual fun procPidRusage(pid: CInt, flavor: CInt, buffer: RusageInfoT): CInt =
    throw UnsupportedOperationException("procPidRusage not available on WASI — no C library access")

public actual fun procSetNoSmt(): CInt =
    throw UnsupportedOperationException("procSetNoSmt not available on WASI — no C library access")

public actual fun procSetthreadNoSmt(): CInt =
    throw UnsupportedOperationException("procSetthreadNoSmt not available on WASI — no C library access")

public actual fun procSetCsm(flags: UInt): CInt =
    throw UnsupportedOperationException("procSetCsm not available on WASI — no C library access")

public actual fun procSetthreadCsm(flags: UInt): CInt =
    throw UnsupportedOperationException("procSetthreadCsm not available on WASI — no C library access")

public actual fun gethostuuid(id: COpaquePointer?, timeout: Timespec?): CInt =
    throw UnsupportedOperationException("gethostuuid not available on WASI — no C library access")
...
public actual fun nSGetExecutablePath(buf: String?, bufsize: UInt?): CInt =
    throw UnsupportedOperationException("nSGetExecutablePath not available on WASI — no C library access")

public actual fun nSGetArgv(): COpaquePointer? =
    throw UnsupportedOperationException("nSGetArgv not available on WASI — no C library access")

public actual fun nSGetArgc(): CInt? =
    throw UnsupportedOperationException("nSGetArgc not available on WASI — no C library access")

public actual fun nSGetEnviron(): COpaquePointer? =
    throw UnsupportedOperationException("nSGetEnviron not available on WASI — no C library access")

public actual fun nSGetProgname(): COpaquePointer? =
    throw UnsupportedOperationException("nSGetProgname not available on WASI — no C library access")
...
public actual fun machVmMap(targetTask: VmMapT, address: MachVmAddressT?, size: MachVmSizeT, mask: MachVmOffsetT, flags: CInt, `object`: MemEntryNamePortT, offset: MemoryObjectOffsetT, copy: BooleanT, curProtection: VmProtT, maxProtection: VmProtT, inheritance: VmInheritT): KernReturnT =
    throw UnsupportedOperationException("machVmMap not available on WASI — no C library access")

public actual fun vmAllocate(targetTask: VmMapT, address: VmAddressT?, size: VmSizeT, flags: CInt): KernReturnT =
    throw UnsupportedOperationException("vmAllocate not available on WASI — no C library access")

public actual fun vmDeallocate(targetTask: VmMapT, address: VmAddressT, size: VmSizeT): KernReturnT =
    throw UnsupportedOperationException("vmDeallocate not available on WASI — no C library access")
...
public actual fun hostStatistics64(hostPriv: HostT, flavor: HostFlavorT, hostInfo64Out: HostInfo64T, hostInfo64OutCnt: MachMsgTypeNumberT?): KernReturnT =
    throw UnsupportedOperationException("hostStatistics64 not available on WASI — no C library access")
...
public actual fun hostProcessorInfo(host: HostT, flavor: ProcessorFlavorT, outProcessorCount: NaturalT?, outProcessorInfo: ProcessorInfoArrayT, outProcessorInfoCnt: MachMsgTypeNumberT?): KernReturnT =
    throw UnsupportedOperationException("hostProcessorInfo not available on WASI — no C library access")

public actual fun taskForPid(host: MachPortT, pid: PidT, task: MachPortT?): KernReturnT =
    throw UnsupportedOperationException("taskForPid not available on WASI — no C library access")
...
public actual fun taskInfo(host: MachPortT, flavor: TaskFlavorT, taskInfoOut: TaskInfoT, taskInfoCount: MachMsgTypeNumberT?): KernReturnT =
    throw UnsupportedOperationException("taskInfo not available on WASI — no C library access")
...
public actual fun taskCreate(targetTask: TaskT, ledgers: LedgerArrayT, ledgersCnt: MachMsgTypeNumberT, inheritMemory: BooleanT, childTask: TaskT?): KernReturnT =
    throw UnsupportedOperationException("taskCreate not available on WASI — no C library access")

public actual fun taskTerminate(targetTask: TaskT): KernReturnT =
    throw UnsupportedOperationException("taskTerminate not available on WASI — no C library access")

public actual fun taskThreads(targetTask: TaskInspectT, actList: ThreadActArrayT, actListCnt: MachMsgTypeNumberT?): KernReturnT =
    throw UnsupportedOperationException("taskThreads not available on WASI — no C library access")
...
public actual fun hostStatistics(hostPriv: HostT, flavor: HostFlavorT, hostInfoOut: HostInfoT, hostInfoOutCnt: MachMsgTypeNumberT?): KernReturnT =
    throw UnsupportedOperationException("hostStatistics not available on WASI — no C library access")
...
public actual fun getattrlist(path: String?, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: UInt): CInt =
    throw UnsupportedOperationException("getattrlist not available on WASI — no C library access")
...
public actual fun fgetattrlist(fd: CInt, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: UInt): CInt =
    throw UnsupportedOperationException("fgetattrlist not available on WASI — no C library access")
...
public actual fun getattrlistat(fd: CInt, path: String?, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: CULong): CInt =
    throw UnsupportedOperationException("getattrlistat not available on WASI — no C library access")
...
public actual fun setattrlist(path: String?, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: UInt): CInt =
    throw UnsupportedOperationException("setattrlist not available on WASI — no C library access")
...
public actual fun fsetattrlist(fd: CInt, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: UInt): CInt =
    throw UnsupportedOperationException("fsetattrlist not available on WASI — no C library access")
...
public actual fun setattrlistat(dirFd: CInt, path: String?, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: UInt): CInt =
    throw UnsupportedOperationException("setattrlistat not available on WASI — no C library access")
...
public actual fun getattrlistbulk(dirfd: CInt, attrList: COpaquePointer?, attrBuf: COpaquePointer?, attrBufSize: ULong, options: ULong): CInt =
    throw UnsupportedOperationException("getattrlistbulk not available on WASI — no C library access")

public actual fun mallocSize(ptr: COpaquePointer?): ULong =
    throw UnsupportedOperationException("mallocSize not available on WASI — no C library access")

public actual fun mallocGoodSize(size: ULong): ULong =
    throw UnsupportedOperationException("mallocGoodSize not available on WASI — no C library access")
...
public actual fun freadlink(fd: CInt, buf: String?, size: ULong): CInt =
    throw UnsupportedOperationException("freadlink not available on WASI — no C library access")
...
public actual fun taskSetInfo(targetTask: TaskT, flavor: TaskFlavorT, taskInfoIn: TaskInfoT, taskInfoInCnt: MachMsgTypeNumberT): KernReturnT =
    throw UnsupportedOperationException("taskSetInfo not available on WASI — no C library access")
