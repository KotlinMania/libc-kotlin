...
public actual fun pthreadAttrGetinheritsched(attr: PthreadAttrT, inheritsched: CInt?): CInt =
    throw UnsupportedOperationException("pthreadAttrGetinheritsched not available on WASI — no C library access")
...
public actual fun pthreadAttrGetschedpolicy(attr: PthreadAttrT, policy: CInt?): CInt =
    throw UnsupportedOperationException("pthreadAttrGetschedpolicy not available on WASI — no C library access")
...
public actual fun pthreadAttrSetstack(attr: PthreadAttrT, stackaddr: COpaquePointer?, stacksize: ULong): CInt =
    throw UnsupportedOperationException("pthreadAttrSetstack not available on WASI — no C library access")
...
public actual fun pthreadCleanupPop(execute: CInt): COpaquePointer? =
    throw UnsupportedOperationException("pthreadCleanupPop not available on WASI — no C library access")
...
public actual fun pthreadGetconcurrency(): CInt =
    throw UnsupportedOperationException("pthreadGetconcurrency not available on WASI — no C library access")
...
public actual fun pthreadMutexattrGetprioceiling(attr: PthreadMutexattrT, prioceiling: CInt?): CInt =
    throw UnsupportedOperationException("pthreadMutexattrGetprioceiling not available on WASI — no C library access")

public actual fun pthreadMutexattrGetprotocol(attr: PthreadMutexattrT, protocol: CInt?): CInt =
    throw UnsupportedOperationException("pthreadMutexattrGetprotocol not available on WASI — no C library access")
...
public actual fun pthreadMutexattrSetprioceiling(attr: PthreadMutexattrT, prioceiling: CInt): CInt =
    throw UnsupportedOperationException("pthreadMutexattrSetprioceiling not available on WASI — no C library access")

public actual fun pthreadMutexattrSetprotocol(attr: PthreadMutexattrT, protocol: CInt): CInt =
    throw UnsupportedOperationException("pthreadMutexattrSetprotocol not available on WASI — no C library access")
...
public actual fun pthreadMutexGetprioceiling(mutex: PthreadMutexT?, prioceiling: CInt?): CInt =
    throw UnsupportedOperationException("pthreadMutexGetprioceiling not available on WASI — no C library access")

public actual fun pthreadMutexSetprioceiling(mutex: PthreadMutexT?, prioceiling: CInt, oldCeiling: CInt?): CInt =
    throw UnsupportedOperationException("pthreadMutexSetprioceiling not available on WASI — no C library access")
...
public actual fun pthreadSetcancelstate(state: CInt, oldstate: CInt?): CInt =
    throw UnsupportedOperationException("pthreadSetcancelstate not available on WASI — no C library access")

public actual fun pthreadSetcanceltype(type: CInt, oldtype: CInt?): CInt =
    throw UnsupportedOperationException("pthreadSetcanceltype not available on WASI — no C library access")

public actual fun pthreadSetconcurrency(newLevel: CInt): CInt =
    throw UnsupportedOperationException("pthreadSetconcurrency not available on WASI — no C library access")
...
public actual fun pthreadSetschedprio(thread: PthreadT, prio: CInt): CInt =
    throw UnsupportedOperationException("pthreadSetschedprio not available on WASI — no C library access")
...
public actual fun pthreadTestcancel(): COpaquePointer? =
    throw UnsupportedOperationException("pthreadTestcancel not available on WASI — no C library access")
...
public actual fun endmntent(streamp: FILE?): CInt =
    throw UnsupportedOperationException("endmntent not available on WASI — no C library access")
...
public actual fun fattach(fildes: CInt, path: String?): CInt =
    throw UnsupportedOperationException("fattach not available on WASI — no C library access")
...
public actual fun fgetgrent(file: FILE?): Group? =
    throw UnsupportedOperationException("fgetgrent not available on WASI — no C library access")
...
public actual fun fgetpwent(file: FILE?): Passwd? =
    throw UnsupportedOperationException("fgetpwent not available on WASI — no C library access")
...
public actual fun fseeko64(stream: FILE?, offset: Off64T, whence: CInt): CInt =
    throw UnsupportedOperationException("fseeko64 not available on WASI — no C library access")

public actual fun fsetpos64(stream: FILE?, ptr: Fpos64T?): CInt =
    throw UnsupportedOperationException("fsetpos64 not available on WASI — no C library access")
...
public actual fun ftello64(stream: FILE?): Off64T =
    throw UnsupportedOperationException("ftello64 not available on WASI — no C library access")
...
public actual fun getgrset(user: String?): String? =
    throw UnsupportedOperationException("getgrset not available on WASI — no C library access")
...
public actual fun getmntent(stream: FILE?): Mntent? =
    throw UnsupportedOperationException("getmntent not available on WASI — no C library access")
...
public actual fun getpeereid(socket: CInt, euid: UidT?, egid: GidT?): CInt =
    throw UnsupportedOperationException("getpeereid not available on WASI — no C library access")
...
public actual fun hasmntopt(mnt: Mntent?, opt: String?): String? =
    throw UnsupportedOperationException("hasmntopt not available on WASI — no C library access")
...
public actual fun loadquery(flags: CInt, buf: COpaquePointer?, buflen: CUInt, vararg args: Any?): CInt =
    throw UnsupportedOperationException("loadquery not available on WASI — no C library access")

public actual fun lparGetInfo(command: CInt, buf: COpaquePointer?, bufsize: ULong): CInt =
    throw UnsupportedOperationException("lparGetInfo not available on WASI — no C library access")

public actual fun lparSetResources(id: CInt, resource: COpaquePointer?): CInt =
    throw UnsupportedOperationException("lparSetResources not available on WASI — no C library access")
...
public actual fun pollsetCtl(ps: PollsetT, pollctlArray: PollCtl?, arrayLength: CInt): CInt =
    throw UnsupportedOperationException("pollsetCtl not available on WASI — no C library access")

public actual fun pollsetDestroy(ps: PollsetT): CInt =
    throw UnsupportedOperationException("pollsetDestroy not available on WASI — no C library access")

public actual fun pollsetPoll(ps: PollsetT, polldataArray: Pollfd?, arrayLength: CInt, timeout: CInt): CInt =
    throw UnsupportedOperationException("pollsetPoll not available on WASI — no C library access")

public actual fun pollsetQuery(ps: PollsetT, pollfdQuery: Pollfd?): CInt =
    throw UnsupportedOperationException("pollsetQuery not available on WASI — no C library access")
...
public actual fun ptrace64(request: CInt, id: CLongLong, addr: CLongLong, data: CInt, buff: CInt?): CInt =
    throw UnsupportedOperationException("ptrace64 not available on WASI — no C library access")
...
public actual fun regcomp(preg: RegexT?, pattern: String?, cflags: CInt): CInt =
    throw UnsupportedOperationException("regcomp not available on WASI — no C library access")
...
public actual fun regexec(preg: RegexT?, input: String?, nmatch: ULong, pmatch: RegmatchT?, eflags: CInt): CInt =
    throw UnsupportedOperationException("regexec not available on WASI — no C library access")
...
public actual fun setmntent(filename: String?, ty: String?): FILE? =
    throw UnsupportedOperationException("setmntent not available on WASI — no C library access")
...
public actual fun stat64at(dirfd: CInt, path: String?, buf: Stat64?, flags: CInt): CInt =
    throw UnsupportedOperationException("stat64at not available on WASI — no C library access")
...
public actual fun strcasecmpL(string1: String?, string2: String?, locale: LocaleT): CInt =
    throw UnsupportedOperationException("strcasecmpL not available on WASI — no C library access")
...
public actual fun strncasecmpL(string1: String?, string2: String?, length: ULong, locale: LocaleT): CInt =
    throw UnsupportedOperationException("strncasecmpL not available on WASI — no C library access")
