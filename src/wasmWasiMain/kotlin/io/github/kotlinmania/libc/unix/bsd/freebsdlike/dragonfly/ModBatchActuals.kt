...
public actual fun getlastlogx(fname: String?, uid: UidT, ll: Lastlogx?): Lastlogx? =
    throw UnsupportedOperationException("getlastlogx not available on WASI — no C library access")

public actual fun updlastlogx(fname: String?, uid: UidT, ll: Lastlogx?): CInt =
    throw UnsupportedOperationException("updlastlogx not available on WASI — no C library access")
...
public actual fun sysCheckpoint(tpe: CInt, fd: CInt, pid: PidT, retval: CInt): CInt =
    throw UnsupportedOperationException("sysCheckpoint not available on WASI — no C library access")

public actual fun umtxSleep(ptr: CInt?, value: CInt, timeout: CInt): CInt =
    throw UnsupportedOperationException("umtxSleep not available on WASI — no C library access")

public actual fun umtxWakeup(ptr: CInt?, count: CInt): CInt =
    throw UnsupportedOperationException("umtxWakeup not available on WASI — no C library access")
...
public actual fun getmntvinfo(mntbufp: COpaquePointer?, mntvbufp: COpaquePointer?, flags: CInt): CInt =
    throw UnsupportedOperationException("getmntvinfo not available on WASI — no C library access")
