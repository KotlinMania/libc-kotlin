...
public actual fun pthreadIntrospectionSetspecificNp(thread: PthreadT, key: PthreadKeyT, value: COpaquePointer?): CInt =
    throw UnsupportedOperationException("pthreadIntrospectionSetspecificNp not available on WASI — no C library access")

public actual fun pthreadIntrospectionGetspecificNp(thread: PthreadT, key: PthreadKeyT): COpaquePointer? =
    throw UnsupportedOperationException("pthreadIntrospectionGetspecificNp not available on WASI — no C library access")
