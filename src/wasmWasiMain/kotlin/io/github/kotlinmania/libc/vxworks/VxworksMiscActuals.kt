...
public actual fun fdopen(fd: CInt, mode: String?): FILE? =
    throw UnsupportedOperationException("fdopen not available on WASI — no C library access for FILE type")
...
public actual fun getprotobynumber(proto: CInt): Protoent? =
    throw UnsupportedOperationException("getprotobynumber not available on WASI — no C library access for Protoent type")

public actual fun lseek(fd: CInt, offset: OffT, whence: CInt): OffT =
    throw UnsupportedOperationException("lseek not available on WASI — no C library access for OffT type")
...
public actual fun mqOpen(name: String?, oflag: CInt, vararg args: Any?): MqdT =
    throw UnsupportedOperationException("mqOpen not available on WASI — no C library access for MqdT type")
...
public actual fun read(fd: CInt, buf: COpaquePointer?, count: ULong): SsizeT =
    throw UnsupportedOperationException("read not available on WASI — no C library access for COpaquePointer param")

public actual fun readv(fd: CInt, iov: Iovec?, iovcnt: CInt): SsizeT =
    throw UnsupportedOperationException("readv not available on WASI — no C library access for Iovec type")

public actual fun recv(s: CInt, buf: COpaquePointer?, bufLen: ULong, flags: CInt): SsizeT =
    throw UnsupportedOperationException("recv not available on WASI — no C library access for COpaquePointer param")
...
public actual fun recvmsg(socket: CInt, mp: Msghdr?, flags: CInt): SsizeT =
    throw UnsupportedOperationException("recvmsg not available on WASI — no C library access for Msghdr type")

public actual fun send(socket: CInt, buf: COpaquePointer?, len: ULong, flags: CInt): SsizeT =
    throw UnsupportedOperationException("send not available on WASI — no C library access for COpaquePointer param")

public actual fun sendmsg(socket: CInt, mp: Msghdr?, flags: CInt): SsizeT =
    throw UnsupportedOperationException("sendmsg not available on WASI — no C library access for Msghdr type")
...
public actual fun wait(status: CInt?): PidT =
    throw UnsupportedOperationException("wait not available on WASI — no C library access for PidT type")

public actual fun waitpid(pid: PidT, status: CInt?, options: CInt): PidT =
    throw UnsupportedOperationException("waitpid not available on WASI — no C library access for PidT type")

public actual fun write(fd: CInt, buf: COpaquePointer?, count: ULong): SsizeT =
    throw UnsupportedOperationException("write not available on WASI — no C library access for COpaquePointer param")

public actual fun writev(fd: CInt, iov: Iovec?, iovcnt: CInt): SsizeT =
    throw UnsupportedOperationException("writev not available on WASI — no C library access for Iovec type")
