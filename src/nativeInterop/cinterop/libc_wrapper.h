...
/* stdlib.h wrappers */
void* libc_calloc(uint64_t nobj, uint64_t size);
...
/* string.h wrappers */
uint64_t libc_strlen(const char* s);
uint64_t libc_strnlen(const char* s, uint64_t n);
uint64_t libc_strspn(const char* s, const char* accept);
uint64_t libc_strcspn(const char* s, const char* reject);
...
char* libc_strncpy(char* dst, const char* src, uint64_t n);
char* libc_strcat(char* s, const char* ct);
char* libc_strncat(char* s, const char* ct, uint64_t n);
...
int libc_strncmp(const char* s1, const char* s2, uint64_t n);
int libc_strcasecmp(const char* s1, const char* s2);
int libc_strncasecmp(const char* s1, const char* s2, uint64_t n);
void* libc_memchr(const void* s, int c, uint64_t n);
int libc_memcmp(const void* s1, const void* s2, uint64_t n);
void* libc_memcpy(void* dest, const void* src, uint64_t n);
void* libc_memccpy(void* dest, const void* src, int c, uint64_t n);
void* libc_memmove(void* dest, const void* src, uint64_t n);
void* libc_memset(void* s, int c, uint64_t n);
...
int libc_madvise(void* addr, uint64_t len, int advice);
int libc_mincore(void* addr, uint64_t len, unsigned char* vec);
int libc_mlock(const void* addr, uint64_t len);
int libc_mlockall(int flags);
int libc_mprotect(void* addr, uint64_t len, int prot);
int libc_msync(void* addr, uint64_t len, int flags);
int libc_munlock(const void* addr, uint64_t len);
...
int libc_setvbuf(void* stream, const char* buffer, int mode, uint64_t size);
...
int libc_creat(const char* path, uint32_t mode);
int libc_fchown(int fd, uint32_t owner, uint32_t group);
int libc_chown(const char* path, uint32_t uid, uint32_t gid);
int libc_truncate(const char* path, int64_t length);
int libc_gethostname(const char* name, uint64_t len);
int libc_mkfifo(const char* path, uint32_t mode);
int libc_fseeko(void* stream, int64_t offset, int whence);
int libc_mkstemp(const char* template);
int libc_symlinkat(const char* target, int newdirfd, const char* linkpath);
int libc_fchmodat(int dirfd, const char* pathname, uint32_t mode, int flags);
int libc_ftruncate(int fd, int64_t length);
...
int libc_chmod(const char* path, uint32_t mode);
...
int libc_lchown(const char* path, uint32_t uid, uint32_t gid);
...
int32_t libc_getpgid(int32_t pid);
int32_t libc_getpgrp(void);
int32_t libc_setsid(void);
int32_t libc_tcgetpgrp(int fd);
int libc_tcsetpgrp(int fd, int32_t pgrp);
int64_t libc_pread(int fd, void* buf, uint64_t count, int64_t offset);
int64_t libc_pwrite(int fd, void* buf, uint64_t count, int64_t offset);
int libc_flock(int fd, int operation);
int32_t libc_getsid(int32_t pid);
int libc_tcdrain(int fd);
int libc_tcflow(int fd, int action);
int32_t libc_tcgetsid(int fd);
int libc_grantpt(int fd);
int libc_unlockpt(int fd);
int libc_fdatasync(int fd);
int libc_dirfd(void* dirp);
int libc_setreuid(uint32_t ruid, uint32_t euid);
int libc_setregid(uint32_t rgid, uint32_t egid);
...
uint64_t libc_strlcpy(const char* arg1, const char* arg2, uint64_t arg3);
int libc_ffs(int arg1);
int libc_getsubopt(void* arg1, void* arg2, void* arg3);
int libc_killpg(int32_t pgrp, int sig);
