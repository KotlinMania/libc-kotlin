...
This file is the quick-reference operating contract for libc-kotlin. The longer
...
libc-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`libc`](https://crates.io/crates/libc). Upstream Rust is the behavioral oracle while the
